...
<table width="586" border="0" align="center" cellspacing="10">
  <tr>
    <td><img src="imagenes/ministerio_login.jpg" alt="SISTEMA DE GESTION DEL PROGRAMA SUMAR" width="797" height="195"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td bgcolor="#05009F"><table width="100" border="0" align="center" cellpadding="0" cellspacing="10">
          <tr>
            <td nowrap><span class="Estilo7"><?php echo (date("Y") != "2014") ? "2014-".date("Y") : "2014"; ?> <strong>&copy;</strong> Copyright MINISTERIO DE SALUD - PROVINCIA DE SAN LUIS</span></td>
          </tr>
        </table></td>
      </tr>
      <tr>
