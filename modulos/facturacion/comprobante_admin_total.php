...
if (($_POST['guardar']=="Guardar Comprobante")||($_POST['guardar']=="Guardar Comprobante y Facturar")){
		...
		$sql_etareo="SELECT grupopoblacional from nacer.smiafiliados where id_smiafiliados=$id";
		$res_etareo=sql($sql_etareo) or fin_pagina();
		$grupopoblacional=$res_etareo->fields['grupopoblacional'];	    
	      ...
	      $db->StartTrans();
		    ...
		    $query="insert into facturacion.comprobante
		             (id_comprobante, cuie, nombre_medico, fecha_comprobante, clavebeneficiario, id_beneficiarios, fecha_carga,periodo,comentario,id_servicio,activo,grupo_etareo)
		             values
		             ($id_comprobante,'$cuie','$nom_medico','$fecha_comprobante','$clavebeneficiario', $id,'$fecha_carga','$periodo','$comentario','$servicio','N','$grupopoblacional')";	
  ...
  <table width=70% align="center" class="bordes">
	 ...
	 <table class="bordes" align="center" width="70%">
		 <tr align="center" id="sub_tabla">
		 	<td colspan="2">	
		 		Nueva Prestación No Empadronado		 		
		 	</td>
		 </tr>
