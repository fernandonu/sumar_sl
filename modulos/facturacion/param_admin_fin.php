...
<input type="hidden" name="id_nomenclador" value="<?php echo $id_nomenclador?>">
 ...
 <tr><td>
      ...
      <td id=mo colspan="2">
       <b> Descripción del Codigo</b>
		...
		<tr>
         	<td align="center"><br>
			<font size="+1">
         	  <b>Descripcion: <font color="blue"><?php echo $descripcion?></font> </b>
         	  <b>Codigo: <font color="blue"><?php echo $codigo?></font> </b>
         	  <b>Grupo: <font color="blue"><?php echo $grupo?></font> </b>
         	  <b>Sub Grupo: <font color="blue"><?php echo $subgrupo?></font> </b>
         	  <b>Precio: <font color="blue"><?php echo $precio?></font> </b>
			 </font>
         	</td>           	         
         </tr>
		...
		<tr>
		  	<td align="center" colspan="2" class="bordes">		      
		    	<? /*if ($_ses_user['login']=='miguel' or 
		    		$_ses_user['login']=='glhuiller' or 
		    		$_ses_user['login']=='gharce' or 
		    		$_ses_user['login']=='sebastian') 
		    	{$disabled="";}
		    	else {$disabled="disabled";}*/?>
		    	<input type="submit" name="guardar" value="Guardar Parametros" title="Guardar Parametros" Style="width=300px" <?echo $disabled?>>
		    </td>
		 </tr> 
  ...
  <br>   
	 <table class="bordes" align="center" width="90%">
		 ...
		 <tr>
		  	<td align="center" colspan="2" class="bordes">		      
		    	<input type="submit" name="guardar" value="Guardar Diagnostico" title="Guardar Diagnostico" Style="width=300px" onclick="return control_nuevos()" <?echo $disabled?>>
		    </td>
		 </tr> 
	 </table>	
 </td></tr>
...
$query=" SELECT codigo,id_parametro_nomen,usuario,patologias_frecuentes.descripcion FROM facturacion.parametro_nomen
		  left join nomenclador.patologias using (codigo)
		  inner join nomenclador.patologias_frecuentes using (codigo)	
  		  where id_nomenclador=$id_nomenclador
		  order by codigo";
...
<tr><td><table width="90%" class="bordes" align="center">
	<tr align="center" id="mo">
	  <td align="center" width="3%">
	   <img id="imagen_2" src="<?php echo $img_ext?>" border=0 title="Mostrar" align="left" style="cursor:hand;" onclick="muestra_tabla(document.all.prueba_vida,2);" >
	  </td>
	  <td align="center">
	   <b>Diagnosticos</b>
	  </td>
...
<tr><td><table id="prueba_vida" border="1" width="90%" style="display:inline;border:thin groove" align='center'>
	<?if ($res_comprobante->RecordCount()==0){?>
	 ...
	 <?}
	 	...
	 	while (!$res_comprobante->EOF) {?>
	 		...
	 		<tr>
	 			<td><?php echo $res_comprobante->fields['id_parametro_nomen'];?> </td>	
	 			<td><?php echo $res_comprobante->fields['codigo'];?> </td>	
	 			<td><?php echo $res_comprobante->fields['descripcion'];?> </td>	
	 			<td><?php echo $res_comprobante->fields['usuario'];?> </td>	
				...
				<td align="center"><img src='../../imagenes/salir.gif' style='cursor: pointer;' onclick="<?php echo $onclick_provincia?>"></td>		 		
    	 	</tr>			        
 ...
 <tr><td><table width=100% align="center" class="bordes">
  <tr align="center">
   <td>
   <?php $ref = encode_link("param_admin.php",array("id_nomenclador_detalle"=>$id_nomenclador_detalle,"modo_facturacion"=>$modo_facturacion));
    $onclick_elegir="location.href='$ref'";?>
     <input type=button name="volver" value="Volver" onclick=<?php echo $onclick_elegir;?> title="Volver al Listado" style="width=150px">     
   </td>
  </tr>
 </table></td></tr>
