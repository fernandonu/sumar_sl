...
<table cellspacing=2 cellpadding=2 border=0 width=100% align=center>
     <tr>
      <td align=center>
		<?
	$link=encode_link("listado_factura_dep_pcia_excel_2014.php",array("cuie"=>$cuie,"fecha_desde"=>$fecha_desde,"fecha_hasta"=>$fecha_hasta));?>
...
$sql_tmp=" SELECT
			...
			(expediente.transaccion_backup.fecha_mov BETWEEN '$fecha_desde_q' AND '$fecha_hasta_q') AND
			(factura.cuie='$cuie')
			GROUP BY
