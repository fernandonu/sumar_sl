...
{global $periodo,$id_factura;
	...
	$this->Image('logo_largo_sumar.png',115,10,85);
	...
	$this->setxy(60,18);
	$this->cell(83,5,utf8_decode("Periodo Prestación"));
	/*Para licitacion*/
	$this->SetFont('Arial','B',18);
    $this->setxy(5,31);
    $this->SetFillColor(234,234,234);
    $this->cell(200,9,utf8_decode("Número Resumen"),1,1,'L',1);
	if($this->PageNo()!=1)
	{
	 $this->setxy(5,45);
	 $this->SetFontSize(11);
	 $this->cell(0,0,"Resumen de Prestaciones Periodo: ".$periodo.utf8_decode(" - Continuación"),0,0,'C');
...
function producto($nom_ape,$cantidad,$unitario,$moneda) {
	...
	$this->MultiCell(125,6,utf8_decode($nom_ape),'TRLB','L');
...
function _final($preciototal,$moneda,$firma1,$firma2,$firma3,$monto_normal,$monto_hombre) {
  ...
  $this->setxy(135,$this->recuperar_base2()+5);
	$this->cell(35,6,'Monto Fact. Normal:',0);
	$this->setxy(170,$this->recuperar_base2()+5);
	$this->cell(35,6,$moneda,'TBL',0,'L');
	$this->setxy(170,$this->recuperar_base2()+5);
	$preciototal_formateado= number_format($monto_normal, 2, ',', '.');
	$this->cell(35,6,$preciototal_formateado,'TRB',0,'R');
	
  $this->setxy(135,$this->recuperar_base2()+10);
  $this->cell(35,6,'Monto Fact. Hombres:',0);
  $this->setxy(170,$this->recuperar_base2()+10);
  $this->cell(35,6,$moneda,'TBL',0,'L');
  $this->setxy(170,$this->recuperar_base2()+10);
  $preciototal_formateado= number_format($monto_hombre, 2, ',', '.');
  $this->cell(35,6,$preciototal_formateado,'TRB',0,'R');
  //fin subtotales hombres

  $this->setxy(135,$this->recuperar_base2()+15);
  $this->cell(35,6,'Total:',1);
  $this->setxy(170,$this->recuperar_base2()+15);
  $this->cell(35,6,$moneda,'TBL',0,'L');
  $this->setxy(170,$this->recuperar_base2()+15);
  ...
  $this->setxy(150,$this->recuperar_base2()+15);
	...
	$this->SetFont('Arial','B',14);
	$this->cell(50,26,'Sin otro particular, saluda atentamente:');
...
//	$this->cell(30,6,'Nº Orden de Compra ');
	...
	$this->cell(200,5,utf8_decode("Por la presente cumplo  dirigirme a  Usted solicitando  la  provisión de las prestaciones que  detallo a "));
	$this->setxy(7,$this->recuperar_base1()+33);
	$this->cell(200,5,utf8_decode("continuación. Solicito me responda por este mismo medio la conformidad de la misma."));
...
function Footer()
{
 //ir a 1.2 cm del final de la hoja
    ...
    $this->Cell(0,10,utf8_decode("Liquidacion de Prestaciones - Página ").$this->PageNo().'/total_pag',0,0,'C');
