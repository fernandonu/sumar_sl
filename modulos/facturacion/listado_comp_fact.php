...
$cuie=(isset($parametros['cuie'])) ? $parametros['cuie'] : $cuie=$_POST['cuie'];
$id_factura=(isset($parametros['id_factura']))? $parametros['id_factura']:$id_factura=$_POST['id_factura'];
$sql_estado_factura="select * from facturacion.factura where id_factura=$id_factura";
$res_estado_factura=sql($sql_estado_factura) or fin_pagina();
$estado_fact=$res_estado_factura->fields['estado'];
//mail
if ($res_estado_factura->fields['estado']=='C') {
  date_default_timezone_set('Europe/Madrid');
  setlocale(LC_TIME, 'spanish');
  $dia_hoy=strftime("%A %d de %B de %Y");
  
  $ret .= "<table width='65%'  bgcolor='blue' align='center' style='border: 2px solid #000000; font-size=14px;'>\n";
  $ret .= "<tr bgcolor='blue'>\n";
  $ret .= "<td align='center'>\n";
  $ret .= "<b>FORMULARIO I</b>\n";
  $ret .= "</td>\n";
  $ret .= "</tr>\n";
  $ret .= "<tr bgcolor='blue' align='right'>\n";
  $ret .= "<td align='rigth'>\n";
  $ret .= "<b>Plan SUMAR, $dia_hoy</b>\n";
  $ret .= "</td>\n";
  $ret .= "</tr>\n";
  $ret .= "<tr bgcolor='blue' align='left'>\n";
  $ret .= "<td align='left'>\n";
  ...
  enviar_mail_html('seba1202@gmail.com','Alerta de Vinculacion de factura - Factura Cerrada',$ret,0,0,0); 
  };
//fin mail

//$periodo_actual=(isset($parametros['periodo_actual'])) or $periodo_actual=$_POST['periodo_actual'];
//$alta_comp=(isset($parametros['alta_comp'])) or $alta_comp=$_POST['alta_comp'];
$periodo_actual = (isset($parametros['periodo_actual']))? $parametros['periodo_actual']:$_POST['periodo_actual'];
$alta_comp=(isset($parametros['alta_comp']))?$parametros['alta_comp']:$alta_comp=$_POST['alta_comp'];
...
if($estado_fact!='C' and isset($parametros["vincula_compro"]) and $parametros["vincula_compro"]=="ok"){
...
if($estado_fact!='C' and $_POST["vincular_todo"]=="Vincular Todo"){
  ...
  // if (es_cuie($_ses_user['login'])&&($res_parametro=='si')){
	...
	and (alta_comp='$alta_comp' or alta_comp is NULL or alta_comp='')
