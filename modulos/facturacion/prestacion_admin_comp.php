  ...
  if ($modo_facturacion=='2'){
    ...
    $id_tema=$result_id_tema->fields['id_categoria_prestacion'];
      ...
      $dias_de_vida=GetCountDaysBetweenTwoDates($fecha_nacimiento, $fecha_comprobante);
        ...
        if ($dias_de_vida>7300) $grupo_etareo='Adulto'; 
...
//ahora (2017) lo tengo que sacar en funcion de la fecha de comprobante
//en el 2017 hubo un nuevo nomenclador
$sql_1="SELECT * FROM facturacion.nomenclador_detalle
    where modo_facturacion='3' and ('$fecha_comprobante' between fecha_desde and fecha_hasta)";
   ...
   <table class="bordes" align="center" width="95%">
              ...
              <td align="right">
                ...
                <td align="left">
                  ...
                  onchange="borrar_buffer(); document.forms[0].submit();">
                    ...
                    WHERE ((id_nomenclador_detalle = '$id_nomenclador_detalle_comp') and (neo='1' or ceroacinco='1')) order by definicion";
              ...
              <td align="right">
                ...
                <td align="left">
                  ...
                  <?$sql= "SELECT * FROM facturacion.nomenclador 
                    WHERE ((id_nomenclador_detalle = '$id_nomenclador_detalle_comp') and (
                    neo='1' or ceroacinco='1')
                    --tipo_nomenclador='$grupo') and (definicion='$definicion')
                  ) order by codigo";
                  $res_efectores=sql($sql) or fin_pagina();
                  while (!$res_efectores->EOF){ 
                    ...
                    <option value=-1>Seleccione</option>
                          ...
                          if ($grupo_etareo=='Neonato'){
                            $sql= "SELECT * 
                                ...
                                where 
                                  (id_nomenclador_detalle='$id_nomenclador_detalle_comp'
                                  or grupo_patologias='PPAC') and
                                  (neo='1')
                                order by codigo";
                          }
     ...
     <tr> 
        <td align="center" colspan="4" class="bordes">
          <?php
          if ($tema=='') {
            $query_aux="SELECT * from facturacion.nomenclador where id_nomenclador=$prestacion";
            $sql_aux=sql ($query_aux) or fin_pagina();
            $tema=$sql_aux->fields['codigo'];
          }

          $query_trz="SELECT *
                FROM nomenclador.trz_pres
                WHERE obj_prestacion_vincula='$tema'
