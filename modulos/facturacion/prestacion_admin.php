...
$sql="SELECT * FROM facturacion.nomenclador_detalle where modo_facturacion='4' and '$fecha_comprobante' between fecha_desde and fecha_hasta";
		 ...
		 <tr>
		  	<td align="center" colspan="2" class="bordes">
		  		...
		  		if (($usuario1)&&(($res_codigo=='MEM 01')||($res_codigo=='MER 15')||($res_codigo=='MER 16')||($res_codigo=='NPE 32')||($res_codigo=='NPE 33'))) 
		  			...
		  			$hab_on_line='';
		  		?>
		  		<input type="submit" name="guardar" id="guardar_prestacion" value="Guardar Prestacion" title="Guardar Prestacion" Style="width=300px;height=40px" onclick="return control_nuevos()" <?=$hab_on_line?>>
		    </td>
		 </tr> 
	 </table>	
 </td></tr>
 ...
 <tr><td><table width=100% align="center" class="bordes">
  <tr align="center">
   <td>
     ...
     switch ($res_codigo){
     	case 'MEM 01' : ?>&nbsp;&nbsp;&nbsp;<input type=button name="carga_trazadora" value="Trazadora Embarazada" onclick="window.open('<?=$ref?>','Trazadoras','dependent:yes,width=900,height=700,top=1,left=60,scrollbars=yes');" title="Carga Trazadora Embarazada" style="widthç:150px;background-color:#F781F3;"> <?
     		break;
		case 'REM 76' : ?>&nbsp;&nbsp;&nbsp;<input type=button name="carga_trazadora" value="Trazadora Embarazada" onclick="window.open('<?=$ref?>','Trazadoras','dependent:yes,width=900,height=700,top=1,left=60,scrollbars=yes');" title="Carga Trazadora Embarazada" style="widthç:150px;background-color:#F781F3;"> <?
     		break;			
     	case 'MPA 17': ?>&nbsp;&nbsp;&nbsp;<input type=button name="carga_trazadora" value="Trazadora Partos" onclick="window.open('<?=$ref?>','Trazadoras','dependent:yes,width=900,height=700,top=1,left=60,scrollbars=yes');" title="Carga Trazadora Partos" style="widthç:150px;background-color:#F781F3;"> <?
     		break;
     	case 'MPA 18': ?>&nbsp;&nbsp;&nbsp;<input type=button name="carga_trazadora" value="Trazadora Partos" onclick="window.open('<?=$ref?>','Trazadoras','dependent:yes,width=900,height=700,top=1,left=60,scrollbars=yes');" title="Carga Trazadora Partos" style="widthç:150px;background-color:#F781F3;"> <?
     		break;
     	case 'NPE 32': ?>&nbsp;&nbsp;&nbsp;<input type=button name="carga_trazadora" value="Trazadora Niño" onclick="window.open('<?=$ref?>','Trazadoras','dependent:yes,width=900,height=700,top=1,left=60,scrollbars=yes');" title="Carga Trazadora Niño" style="widthç:150px;background-color:#F781F3;"> <?
     		break;
		case 'RPE 86': ?>&nbsp;&nbsp;&nbsp;<input type=button name="carga_trazadora" value="Trazadora Niño" onclick="window.open('<?=$ref?>','Trazadoras','dependent:yes,width=900,height=700,top=1,left=60,scrollbars=yes');" title="Carga Trazadora Niño" style="widthç:150px;background-color:#F781F3;"> <?
     		break;
     	case 'NPE 33': ?>&nbsp;&nbsp;&nbsp;<input type=button name="carga_trazadora" value="Trazadora Niño" onclick="window.open('<?=$ref?>','Trazadoras','dependent:yes,width=900,height=700,top=1,left=60,scrollbars=yes');" title="Carga Trazadora Niño" style="widthç:150px;background-color:#F781F3;"> <?
     		break; 
		case 'RPE 87': ?>&nbsp;&nbsp;&nbsp;<input type=button name="carga_trazadora" value="Trazadora Niño" onclick="window.open('<?=$ref?>','Trazadoras','dependent:yes,width=900,height=700,top=1,left=60,scrollbars=yes');" title="Carga Trazadora Niño" style="widthç:150px;background-color:#F781F3;"> <?
     		break;			
     }?>
