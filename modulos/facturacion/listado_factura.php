...
<table border=0 width=100% cellspacing=2 cellpadding=2 bgcolor='<?=$bgcolor3?>' align=center>
  ...
  <tr>
    ...
    <td align=right id=mo><a id=mo href='<?=encode_link("listado_factura.php",array("sort"=>"5","up"=>$up))?>'>Fecha de Ingreso</a></td>
 ...
 <?
   while (!$result->EOF) {
    ...
    <tr <?=atrib_tr()?>>     
     <td align="center" onclick="<?=$onclick_elegir?>"><?=$result->fields['id_factura']?></td>
     ...
     <td align="center" onclick="<?=$onclick_elegir?>"><?=fecha($result->fields['fecha_factura'])?></td>
     <td align="center" onclick="<?=$onclick_elegir?>"><?=fecha($result->fields['fecha_ing'])?></td>     
     <!--<td onclick="<?=$onclick_elegir?>"><?=Fecha($result->fields['fecha_carga'])?></td> -->
     <td align="center" onclick="<?=$onclick_elegir?>"><?=$result->fields['periodo']?></td> 
     <td align="center" onclick="<?=$onclick_elegir?>"><?=$result->fields['periodo_actual']?></td> 
