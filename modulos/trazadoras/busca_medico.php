...
<font size=2><b>Ingrese Nombre, Apellido o Nro. Documento del promotor</b></font>
 ...
 <font size=2 color = "blue"><b>Luego Presione ENTER</b></font>
...
$res_efectores=sql($sql) or fin_pagina();
	 ?>
					<script>
						document.getElementById('valor_buscar').value='<?php echo $valor_buscar?>';
					</script>
				  <tr>
...
<?
			while (!$res_efectores->EOF){ if(rtrim($res_efectores->fields['dni_medico'])==''){$dni_medico='S/D';}else{$dni_medico=rtrim($res_efectores->fields['dni_medico']);}?>
					<tr>
					<td>&nbsp;<a href="#" onclick="opener.document.forms.form1.dni_medico.value = '<?php echo $dni_medico?>'; opener.document.forms.form1.nombre_medico.value = '<?php echo $res_efectores->fields['nombre_medico']?>'; opener.document.forms.form1.apellido_medico.value = '<?php echo $res_efectores->fields['apellido_medico']?>';opener.document.forms.form1.id_medico.value = '<?php echo $res_efectores->fields['id_medico']?>';opener.document.forms.form1.dni_medico.readOnly = true; opener.document.forms.form1.nombre_medico.readOnly = true; opener.document.forms.form1.apellido_medico.readOnly = true; window.close();" style="text-decoration:none;"><font size=2><?php echo $dni_medico?></font></a></td>
					<td>&nbsp;<font size=2><? echo $res_efectores->fields['apellido_medico']; ?></font>&nbsp;</td>
                    <td>&nbsp;<font size=2><?php echo $res_efectores->fields['nombre_medico']?></font>&nbsp;</td>
