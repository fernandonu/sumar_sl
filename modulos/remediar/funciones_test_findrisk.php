...
function insertar_comprobante ($cuie,$nom_medico,$fecha_control,$clavebeneficiario,$id_smiafiliados,$fecha_carga,$comentario,$grupopoblacional) {
...
function insertar_prestacion ($id_comprobante,$fecha_control,$codigo,$descripcion,$id_smiafiliados,$afidni,$diagnostico,$sexo,$fecha_nacimiento,$cuie,$clave_beneficiario,$comentario) {
  ...
  //saco el id_nomenclador_detalles segun el periodo
    ...
    $query="INSERT into facturacion.prestacion
           (id_prestacion,id_comprobante, id_nomenclador,codigo_comp,fecha_nacimiento,edad,sexo,fecha_prestacion,anio,mes,dia,cantidad,precio_prestacion,id_anexo,diagnostico,estado_envio)
           values
           ($id_prestacion,$id_comprobante,$nomenclador,'$codigo','$fecha_nacimiento','$anios_nac','$sexo_codigo','$fecha_control',$anios_nac,$meses_nac,$dias_nac,1,$precio_prestacion,$anexo,'$diagnostico','n')";
