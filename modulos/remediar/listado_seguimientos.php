...
<table cellspacing=2 cellpadding=2 border=0 width=100% align=center>
     <tr>
      ...
      Excel Completo<img src="../../imagenes/excel.gif" style='cursor:hand;'  onclick="window.open('<?php echo $link?>')">

      <? $link=encode_link("listado_seguimiento_excel1.php",array());?>
      Excel Filtrado<img src="../../imagenes/excel.gif" style='cursor:hand;'  onclick="window.open('<?php echo $link?>')">
...
<table class="table table-striped" width=100% cellspacing=2 cellpadding=2 align=center>
  <tr>
  ...
  <tr>
  	<td align='center'><b>Clave Beneficiario</b></td>    	    
    <td align='center'><a href='<?php echo encode_link("ins_listado_old.php",array("sort"=>"1","up"=>$up))?>'><b>Documento</b></a></td>      	    
    <td align='center'><b>Apellido</b></a></td>      	    
    <td align='center'><b>Nombre</b></a></td>
    <td align='center'><b>F NAC</b></td>
    <td align='center'><b>Fecha de Control</b></td>
  </tr>
 <?php
   while (!$result->EOF) {
   ...
   // $onclick_elegir="location.href='$ref'";?>
    ...
    <tr>     
     <td align='center'><?php echo $result->fields['clave_beneficiario']?></td>
     <td align='center'><?php echo $result->fields['numero_doc']?></td>        
     <td align='center'><?php echo $result->fields['apellido_benef']?></td>     
     <td align='center'><?php echo $result->fields['nombre_benef']?></td>     
     <td align='center'><?php echo fecha($result->fields['fecha_nacimiento_benef'])?></td> 
     <td align='center'><?php echo fecha($result->fields['fecha_comprobante'])?></td>   
   </tr>
	<?$result->MoveNext();
    }?>
