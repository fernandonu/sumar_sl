...
if ($_POST['num_form_remediar']!=''){
	...
	}else{ echo "<SCRIPT Language='Javascript'> alert('Debe Cargar el Número de Formulario'); </SCRIPT>";}
}
echo $html_header;
?>
<script>
         ...
         <tr id="ma">
           <td  colspan="4" >
               <b style=" margin-left: 490px">SUMATORIA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>
                 ...
                 <?if (($puntaje_final=='0' or $puntaje_final=='') or($hta2=='-1' and $colesterol4=='-1')) $puntaje_final="";?>
