...
$total_egre_comp_no_pago=$res_saldo->fields['egre_comp']-$res_saldo->fields['egre'];
...
$ret .= "<tr bgcolor='$color1'>\n";
$ret .= "<td align='justify'>\n";
$ret .= "<b>Su Saldo Comprometido es de: $ $total_egre_comp_no_pago. De los cuales $ $total_incentivo corresponde a incentivo.</b>\n";
$ret .= "</td>\n";
$ret .= "</tr>\n";
$ret .= "<tr bgcolor='$color1'>\n";
$ret .= "<td align='justify'>\n";
