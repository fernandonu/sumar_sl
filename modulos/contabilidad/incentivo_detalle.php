 ...
 <?
  ...
  $cumple=$res_inc_det->fields['cumple'];
    ...
    <tr <?=$tr?>> 
     ...
     <?switch ($res_inc_det->fields['cumple']) {
       case 0:$estado="Incentivo Rechazados";break;
       case 1:$estado="Incentivos Aceptados";break;
       case 2:$estado="Incentivos Pendientes";break;
       case 3:$estado="Incentivos Aceptados Parcialmente";break;
     }?>
