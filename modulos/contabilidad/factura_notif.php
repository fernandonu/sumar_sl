...
$q_periodo="select periodo_actual from facturacion.factura where id_factura='$id_factura'";
$rs_periodo=sql($q_periodo) or fin_pagina();
$periodo_actual=$rs_periodo->fields['periodo_actual'];
...
$ret .= "<b>Por medio de la presente le notifico que la factura $id_factura con prestaciones correspondiente al periodo $periodo_actual, se encuentra
proximo a vencer, con lo cual solicitamos realizar las cargas y el cierre correspondiente.
Muchas gracias. </b>\n";
$ret .= "</td>\n";
$ret .= "</tr>\n";
$ret .= "<tr bgcolor='$color1'>\n";
...
$res_mail->movefirst();
  ...
  //enviar_mail_html('seba1202@gmail.com','Notificacion de Facturacion',$ret,0,0,0);
