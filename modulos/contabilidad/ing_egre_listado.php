...
if ($_POST['listado_excel']=="Listado EXCEL"){
  $fecha_hasta=$_POST['fecha_hasta'];
  $ref = encode_link("ingre_egre_listado_excel.php",array("fecha_hasta"=>$fecha_hasta));?>
  <script>
  window.open('<?=$ref?>')
  </script>
...
if ($cmd=="VERDADERO")
    $where_tmp=" (efe_conv.conv_sumar=true)";
    

if ($cmd=="FALSO")
    $where_tmp=" (efe_conv.conv_sumar='false')";
...
<table cellspacing=2 cellpadding=2 border=0 width=100% align=center>
     <tr>
      <td align=center>
	    ...
	    &nbsp;&nbsp;
      <!--<button type="button" name="listado_excel" onclick="window.location='ingre_egre_listado_excel.php'">Listado EXCEL</button>
      &nbsp;&nbsp;	-->
...
<table border=0 width=100% cellspacing=2 cellpadding=2 bgcolor='<?=$bgcolor3?>' align=center>
  ...
  <tr>
    ...
    <td align=right id=mo title="ingreso_excel">Ingreso(Excel)</td>
    <td align=right id=mo title="egreso_excel">Egreso(Excel)</td>
    ...
    <tr <?=atrib_tr()?>>        
     ...
     <td bgcolor='<?=$color_fondo1?>'><?=number_format($total_depositado-$res_saldo->fields['egre']-($res_saldo->fields['egre_comp']-$res_saldo->fields['egre']),2,',','.')?></td>          
       ...
       <td align="center" bgcolor='<?=$color_fondo?>'>
         <?$link=encode_link("ingreso_excel.php", array("cuie"=>$result->fields['cuie']));  
       ...
       <td align="center" bgcolor='<?=$color_fondo?>'>
         <?$link=encode_link("egreso_excel.php", array("cuie"=>$result->fields['cuie']));  
