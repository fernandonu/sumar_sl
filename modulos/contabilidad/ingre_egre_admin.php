...
$sql_cons_tranf="select num_tranf from expediente.transaccion where id_factura=$numero_factura and num_tranf is not null and num_tranf<>0";
  ...
  <?if ($res_comprobante->RecordCount()==0){?>
   ...
   <?}
    ...
    <tr id="sub_tabla">         
      ...
      <td width="15%">Fecha Factura(Cierre)</td>
    ...
    while (!$res_comprobante->EOF) {
      ...
      <tr <?=atrib_tr()?>>        
        ...
        <td onclick="<?=$onclick_elegir?>"><?=fecha($res_comprobante->fields['fecha_ing'])?></td>
