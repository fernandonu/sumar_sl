...
<table align="center" border="1">
 ...
 <tr>
   <td colspan="2" align="right">Fecha: <input name="fecha_queja" type="text" value="<?php echo Fecha($result->fields['fecha']) ?>">&nbsp;&nbsp;<?php echo link_calendario("fecha_queja"); ?></td>
 </tr>
 <tr>
   <td>Nombre Cliente:&nbsp;&nbsp;<input name="nombre_cl" type="text" size="50" value=<?php echo $result->fields['nbre_cl'] ?>></td>
 <tr>  
   <td>E-mail: &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<input name="mail" type="text" size="30" value="<?php echo $result->fields['mail'] ?>"></td>
 </tr>
</tr>
<tr><td colspan="2">Descripción:<br>&nbsp;&nbsp;<textarea name="descripcion" cols="60" rows="4"><?php echo $result->fields['descripcion'] ?></textarea></td></tr>
