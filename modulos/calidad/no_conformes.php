...
$query="select id_noconforme,descripcion_inconformidad,fecha_evento,usuario,deteccion,nro_serie from noconformes";
...
<table width='95%' border='0' cellspacing='5' align="center">
    <tr>
      ...
      <td width="15%" align="center" id="mo"><b>Deteccion</b></a></td>
      <td width="15%" align="center" id="mo"><b>Numero de Descripcion</b></a></td>
      <td width="15%" align="center" id="mo"><b>Usuario</b></a></td>
      <td width="30%" align="center" id="mo"><a id="mo" href='<?=encode_link($_SERVER["PHP_SELF"],array("sort"=>"2","up"=>$up))?>'><b>Descripción</b></a></td>
    </tr>
    <?
  $i=1;
  while (!$resultado->EOF )
...
?>
      ...
      <?$href = encode_link("detalle_no_conformes.php", array("pagina"=>"listado","id" =>$resultado->fields["id_noconforme"]));
        $onclick_elegir="location.href='$href'";?> 
      <td onclick="<?=$onclick_elegir?>" align="center"><b><?echo fecha($resultado->fields['fecha_evento']); ?></font></td>
      <td onclick="<?=$onclick_elegir?>" align="center"><b><?echo $resultado->fields['deteccion']; ?></font></td>
      <td onclick="<?=$onclick_elegir?>" align="center"><b><?echo $resultado->fields['nro_serie']; ?></font></td>
      <td onclick="<?=$onclick_elegir?>" align="center"><b><?echo $resultado->fields['usuario']; ?></font></td>
      <td onclick="<?=$onclick_elegir?>" align="center"><b><?echo $resultado->fields['descripcion_inconformidad'];?></font></td>
