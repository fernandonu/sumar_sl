...
<form name='form_archivos' action='<?php echo encode_link($_SERVER['SCRIPT_NAME'],$parametros) ?>' method=POST enctype='multipart/form-data'>
...
<tr>
  <td style="border:#E0E0E0;" colspan=2 align=center id=mo><font size=3><b>Subir Archivos. Hasta <? echo sprintf("%01.2lf",get_cfg_var("upload_max_filesize")/1024/1000); ?> MB</b></td>
</tr><tr>
...
<? for ($i=1; $i<=$max_file_count ; $i++)
   {
?>
	<option <?php echo ($filecount==$i)?"selected":""; ?> ><?php echo $i ?></option>
<? } ?>	
</select>
</td>
</tr>
...
?>
<tr>
  <td align=right>Archivo <?php echo $i;?>: </td>
  <td><input type=file name='archivo[<?php echo ($i++-1); ?>]' size=30></td>
</tr>
<?
 }
?>
...
<input type=submit name='baceptar' value='Aceptar' onclick="document.all.div_aceptar.style.display = 'block';<?php echo $onclick['aceptar']?>">&nbsp;&nbsp;&nbsp;
<input type=button name='bcancelar' value='Cancelar' onclick="<?php echo $onclick["cancelar"]?>">
</table>
<br>
<br>
