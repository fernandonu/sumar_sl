...
<table border=2 width="10%" align="center" class="bordes">		 
		 <tr align="center" id="sub_tabla"  bgcolor="#F7C8E5">
           ...
           <tr align="center" id="sub_tabla" >
			...
			<tr>
				<td align="left">
					Total de Controles de Ninos menor de 1 a̱o segun periodo (por fecha de control): <b><?=$ninios_new_1?></b>
				</td> 
				<td align="left">
					Total de Ni̱os menor de 1 a̱o segun periodo (por fecha de control): <b><?=$ninios_new_pers_1?></b>
				</td>            
            </tr>
            
            <tr>
				<td align="left">
					Total de Controles de Ni̱os de 1 a 2 a̱os segun periodo (por fecha de control): <b><?=$ninios_new_2?></b>
				</td> 
				<td align="left">
					Total de Ni̱os menor de 1 a 2 a̱os segun periodo (por fecha de control): <b><?=$ninios_new_pers_2?></b>
				</td>            
            </tr>
             <tr>
				<td align="left">
					Total de Controles de Ni̱os de 2 a 6 a̱os segun periodo (por fecha de control): <b><?=$ninios_new_3?></b>
				</td> 
				<td align="left">
					Total de Ni̱os menor de 2 a 6 a̱os segun periodo (por fecha de control): <b><?=$ninios_new_pers_3?></b>
				</td>            
            </tr>
            
            <tr>
				<td align="left">
					Total de Controles de Ni̱os menor de 6 a̱os segun periodo (por fecha de control): <b><?=$ninios_new_1+$ninios_new_2+$ninios_new_3?></b>
				</td> 
				<td align="left">
					Total de Ni̱os menor de 6 a̱os segun periodo (por fecha de control): <b><?=$ninios_new_pers_1+$ninios_new_pers_2+$ninios_new_pers_3?></b>
				</td>            
            </tr>
            ...
            <?$sql="select sum (cantidad) as total FROM 
					(SELECT  nacer.efe_conv.cuie, 
												...
												FROM
													...
													LEFT OUTER JOIN uad.beneficiarios on trazadoras.vacunas.id_beneficiarios= uad.beneficiarios.id_beneficiarios
            ...
            <tr>
				<td align="left">
					Total de Controles de Adolescentes de 10 a 19 a̱os segun periodo (por fecha de control): <b><?=$adol_new_3?></b>
				</td> 
				<td align="left">
					Total de Adolescentes de 10 a 19 a̱os segun periodo (por fecha de control): <b><?=$adol_new_pers_3?></b>
				</td>            
            </tr>
