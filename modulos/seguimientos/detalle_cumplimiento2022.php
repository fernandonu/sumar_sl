...
<table width="100%" cellspacing=0 border=1 bordercolor=#E0E0E0 align="center" bgcolor='<?php echo $bgcolor_out?>' class="bordes">		 
		...
		<td align="center" border=1 bordercolor=#2C1701 onclick="<?php echo $onclick_cns_1?>" <?php echo atrib_tr7()?>>
			...
			Total de Controles de Ninos menor de 1 año segun periodo (por fecha de control): <b><?php echo ($ninios_new_1)?$ninios_new_1:0?> / </b><font size=2 color= red> <b>Meta Anual x RRHH: <?php echo $cns_menor_1_año?> </b></font>
		...
		<? $porcentaje=($ninios_1_a_9/$cns_entre_1_y_9)*100;
			$porcentaje=number_format ($porcentaje,2,',','.')?>
			Total de Controles de Niños de 1 a 9 años segun periodo (por fecha de control): <b><?php echo ($ninios_1_a_9)?$ninios_1_a_9:0?> / </b> <!--<font size=2 color= red> <b>Meta anual: <?php echo $cns_entre_1_y_9?> / </b></font>--> <font size=2 color=red> <b>Meta Anual x RRHH: <?php echo $cns_entre_1_y_9?> </b></font>
			<font size=2 color=green><b>(<?php echo $porcentaje?> %) </b></font>
		</td>	   	
		</tr> 
		...
		<td align="center" border=1 bordercolor=#2C1701 onclick="<?php echo $onclick_elegir?>" <?php echo atrib_tr7()?>>
			...
			$porcentaje=number_format ($porcentaje,2,',','.')?>
			Total de Controles que Marca Hipertenso: <b><?php echo ($hip)?$hip:0?> / </b> <!--<font size=2 color= red> <b>Meta Anual: <?php echo $enfermedades_cronicas_HTA?> / </b></font> --><font size=2 color= red> <b>Meta Anual x RRHH: <?php echo $enfermedades_cronicas_HTA?> </b></font>
			<font size=2 color=green><b>(<?php echo $porcentaje?> %) </b></font>
		</td>
		...
		<?$ref_diab = encode_link("detalle_diab.php",array("cuie"=>$cuie,"fecha_desde"=>$fecha_desde,"fecha_hasta"=>$fecha_hasta));
			...
			$porcentaje=number_format ($porcentaje,2,',','.')?>
			Total de Controles que Marca Diabetico: <b><?php echo ($dia)?$dia:0?> / </b> <!--<font size=2 color= red> <b>Meta Anual: <?php echo $enfermedades_cronicas_DBT?> / </b></font>--> <font size=2 color= red> <b>Meta Anual x RRHH: <?php echo $enfermedades_cronicas_DBT?> </b></font>
			<font size=2 color=green><b>(<?php echo $porcentaje?> %) </b></font>
			</td> 
		</tr>
