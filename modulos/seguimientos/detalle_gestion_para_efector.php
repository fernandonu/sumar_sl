...
SELECT * from (
SELECT id_nomenclador from facturacion.nomenclador where id_nomenclador_detalle=12
order by id_nomenclador
) as nomenclador
except 

SELECT id_nomenclador from (
SELECT * from facturacion.comprobante where cuie='$cuie'  and fecha_comprobante between '$fecha_desde' 
and '$fecha_hasta') as comprobantes
inner join facturacion.prestacion using (id_comprobante) 
...
where (codigo='C001' and (diagnostico='A97' or diagnostico='T79' or diagnostico='T82'or diagnostico='T83'
	or diagnostico='R96' or diagnostico='B80' or diagnostico='P20' or diagnostico='P23' or diagnostico='P24'
	or diagnostico='P98' or diagnostico='B72' or diagnostico='B73')) or
	(codigo='C009' and diagnostico='A97') or
	(codigo='C005' and diagnostico='W78') or
	(codigo='C006' and diagnostico='W78') or
	(codigo='C010' and diagnostico='A97') or
	(codigo='C011' and diagnostico='A97') or
	(codigo='C002' and (diagnostico='T79' or diagnostico='T82' or diagnostico='T83' or diagnostico='R96' 
	or diagnostico='B80' or diagnostico='P20' or diagnostico='P23' or diagnostico='P24' or diagnostico='B72'
	or diagnostico='B73')) or
	(codigo='C008' and diagnostico='A97') or
	(codigo='V011') or
	(codigo='V010') or
	(codigo='V008') or
	(codigo='V009') or
	...
	(codigo='T015') or
	(codigo='T016') or
	(codigo='P018' and (diagnostico='P18' or diagnostico='W78')) or
	(codigo='A001' and (diagnostico='A98' or diagnostico='X86' or diagnostico='X75')) or
	(codigo='R014' and diagnostico='A98')
	) as prestaciones
...
<br/>
	...
	<tr><td><table id="priorizado" width=90% align="center" class="bordes" style="display:none;border:thin groove">
			...
			<?$sql_ex="SELECT count (*) as cantidad from (
						...
						where cuie='$cuie' and codigo='Y001' --and descripcion='Diagnóstico socio-epidemiológico de población en riesgo por efector, (Informe final de ronda entregado y aprobado) (Anexo)'
					)as t1";
			...
			<?$sql_ex="SELECT count (*) as cantidad from (
						...
						inner join facturacion.nomenclador using(id_nomenclador)
						left join facturacion.comprobante using (id_comprobante)
						where cuie='$cuie' and (codigo='W004' or codigo='W005') 
					)as t1";
			...
			<?$sql_ex="SELECT count (*) as cantidad from (
						...
						inner join facturacion.nomenclador using(id_nomenclador)
						left join facturacion.comprobante using (id_comprobante)
						where cuie='$cuie' and codigo='W001' 
					)as t1";
			...
			<?$sql_ex="SELECT count (*) as cantidad from (
						select id_comprobante from facturacion.prestacion as t1
						inner join facturacion.nomenclador using (id_nomenclador)
						left join facturacion.comprobante using (id_comprobante)
						where cuie='$cuie' and codigo='C010'
						and descripcion='Control Odontologico adolescentes de 10 a 19')
						as t2";
			...
			<?$sql_ex="SELECT count (*) as cantidad from (
						...
						inner join facturacion.nomenclador using (id_nomenclador)
						left join facturacion.comprobante using (id_comprobante)
						where comprobante.cuie='$cuie' and codigo='V014' 
						and descripcion='Dosis aplicada de Vacuna contra VPH (Virus Papiloma Humano) en niñas de 11 años '
						) as t1";
			...
			<?$sql_ex="SELECT count (*) as cantidad from (
						...
						and codigo='R014' and descripcion='Mamografía bilateral, craneocaudal y oblicua, con proyección axilar  mujeres (en mayores de 49 años (cada 2 años con mamografìa negativa)'
						) as t1";
			...
			<?$sql_ex="SELECT count (*) as cantidad from (
						...
						left join facturacion.comprobante using (id_comprobante)
						where comprobante.cuie='$cuie' 
						and codigo='A001' and descripcion='Lectura de la muestra tomada en mujeres entre 25 y 64 años, en laboratorio de Anatomía Patológica/Citología con diagnóstico firmado por anátomo-patólogo matriculado (tamizaje de CA cervicouterino)'
						) as t1";
			...
			<?$sql_ex="SELECT count (*) as cantidad from (
						...
						left join facturacion.comprobante using (id_comprobante)
						where comprobante.cuie='$cuie' 
						and codigo='A002' and descripcion='Diagnóstico por biopsia en laboratorio de
anatomía patológica, para aquellas mujeres con citología ASC-H, H-SIL,Cáncer
(CA cervicouterino)'
						) as t1";
			$res_sql_ex=sql($sql_ex,"No se puede calcular laboratorio");
			$numerador=$res_sql_ex->fields['cantidad'];
			...
			union
			select distinct id_beneficiarios from trazadorassps.trazadora_12 where cuie = '$cuie' and id_beneficiarios<>0) as t1";
