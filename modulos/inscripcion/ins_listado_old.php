...
/////////DATOS
			...
			//nuevo latitud ,longitud y cuie efector a cargo
			$contenido.=chr(9); // * 15 (version 5.5)
			$contenido.=chr(9);
			$contenido.=chr(9);
			$contenido.=chr(9);
			$contenido.=chr(9);
			...
			$contenido.=chr(9);
			$contenido.=chr(9);
			$contenido.=$result1->fields['ubicacion_latitud'];
			$contenido.=chr(9);
			$contenido.=$result1->fields['ubicacion_longitud'];
			$contenido.=chr(9);
