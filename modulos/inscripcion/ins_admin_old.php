...
if($id_planilla){
	...
	$fecha_nac=$resultado->fields['fecha_nacimiento_benef'];
...
if(($responsable =='MADRE') && ($estado_envio== 'e')){
		...
		if (($id_categoria=='1')&& ($estado_envio=='e'))  {
  		 ...
  		 if ((($id_categoria=='4')||($id_categoria=='7')||($id_categoria=='8'))&& ($estado_envio=='e'))  {
   			$query = "update uad.beneficiarios set 
             cuie_ea='$cuie', nombre_benef=upper('$nombre'),
             apellido_benef=upper('$apellido'),aficuil='$aficuil',
             numero_doc='$num_doc',clase_documento_benef=upper('$clase_doc'),fecha_nacimiento_benef='$fecha_nac',
...
if ($_POST['guardar']=="Guardar Planilla"){
  ...
  $sql1="SELECT * from uad.beneficiarios	  
      ...
      --and fecha_nacimiento_benef = '$fecha_nac1'";
...
if (($res_extra->recordcount()>0) && ($responsable=='TUTOR')) {
   ...
   if (($res_extra->recordcount()>0) && ($id_categoria == '2')) {
    ...
    if (($res_extra->recordcount()>0) && (($id_categoria == '7')||($id_categoria == '8')||($id_categoria == '4'))) {
        	$query="insert into uad.beneficiarios
             (id_beneficiarios,estado_envio,clave_beneficiario,tipo_transaccion,apellido_benef,nombre_benef,clase_documento_benef,
             tipo_documento,numero_doc,id_categoria,sexo,fecha_nacimiento_benef,provincia_nac,localidad_nac,pais_nac,
             indigena,id_tribu,id_lengua,fecha_diagnostico_embarazo,semanas_embarazo,
      ...
      <?php  } 
    }elseif (($res_extra->recordcount()== 0) && (($id_categoria == '7')||($id_categoria == '8')||($id_categoria == '4'))) {
  ...
  //INSERTO EN REMEDIAR REDES
   //inserto en tablas de uad.remediar_x_beneficiario remediar.formulario
            ...
            $fecha_inscripcion_db=Fecha_db($fecha_inscripcion);
...
<?php  } 
} //movido desde la posicion 802 - Probar
...
if ($_POST['b']=="b"){
		...
		if ($res_extra1->recordcount()>0){
			$accion="El Beneficiario ya esta Inscripto";
...
function control_nuevos()
{
 ...
 if (document.all.id_categoria.value=='3'){
 ...
 var docu=document.all.clase_doc.value;
  ...
  if(document.all.telefono.value==""){
    alert("Debe completar el campo telefono o celular, en el caso de no poseer colocar 0");
     return false;
     }

  if(document.all.departamenton.value==""){
    alert("Debe completar el campo DEPARTAMENTO");
     return false;
     }

  if(document.all.localidadn.value==""){
...
function cambiar_patalla(){	
	...
	//si menor de un año es una inscripcion con datos de padre madre o tutor
	if (document.all.id_categoria.value=='3'){
		document.all.cat_emb.style.display='none';
	...
	//si mayor de 1 año es una inscripcion sin datos de padre madre o tutor
	if (document.all.id_categoria.value=='4'){
		document.all.cat_emb.style.display='none';
		document.all.cat_nino.style.display='none';
		document.all.cat_puerp.style.display='none';
	}
	...
	//femenino puerpera menor de 45 días
...
<?php 
if ($id_planilla) {
  $formulario_beneficiario_class1 = "";
  $formulario_beneficiario_class2 = " in";
  $formulario_beneficiario_titulo = "Beneficiario: ${apellido} ${nombre}";
}
else {
  $formulario_beneficiario_class1 = "";
  $formulario_beneficiario_class2 = " in";
  $formulario_beneficiario_titulo = "Nuevo beneficiario";
}
?>
<div class="well well-sm"><h4 class="text-center"><?php echo $formulario_beneficiario_titulo; ?></h4></div>
<div class="row">
  <div class="col-md-12">
  <div class="panel panel-default" id="panel_formulario_beneficiario">
    <div class="panel-heading">
      <b><a data-toggle="collapse" data-target="#formulario_beneficiario" href="#panel_formulario_beneficiario" class="<?php echo $formulario_beneficiario_class1; ?>">
        Datos personales
      </a></b>
    </div>
    <div id="formulario_beneficiario" class="panel-collapse collapse<?php echo $formulario_beneficiario_class2; ?>">
      <div class="panel-body">

<table width="99%" cellspacing=0 border="1" bordercolor=#E0E0E0 align="center" bgcolor='<?=$bgcolor_out?>' class="bordes">
 <tr id="mo">
    <td>
    	<?
    	if (!$id_planilla) {
...
<tr>
  ...
  <input type="submit" size="3" value="b" name="b"> 
  </td>
...
<tr>
  ...
  <option value=CI <?if ($tipo_doc=='CI') echo "selected"?>>Cedula de Identidad</option>
  </select>
  </td>
</tr>
...
<tr>
  ...
  <td align="left">
  <input type=text name=fecha_nac id=fecha_nac onblur="esFechaValida(this);" value="<?if ($id_planilla) echo $fecha_nac; else echo '';?>" size=15 onkeypress="return pulsar(event)" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
...
<tr>
  ...
  <td align="right">
  <b>Se Identifica con Algun Pueblo Originario?: </b>
  </td>         	
  <td align='left'>
  ...
  <input type="radio" name="indigena" value="N"  <?php if(($indigena == "N") or ($indigena==""))echo "checked" ;?> onclick="document.all.id_tribu.disabled=true;document.all.id_lengua.disabled=true;" > NO
...
<tr>
  ...
  <td align='left'>
  <select name=benefAlfab Style="width=200px">
  <option value=''>Seleccione</option>
  <option value='NA'>NO alfabetizado</option>
  <option value='SA'>SI alfabetizado</option>
  <option value='II'>Nivel inicial incompleto</option>
  <option value='IC'>Nivel inicial completo</option>
  <option value='PI'>Primario incompleto</option>
  <option value='PC'>Primario completo</option>
    ...
    <input type="text" name="aficuil" id="aficuil" value="<?php echo $aficuil; ?>" maxlength="11" pattern="\d{11}" inputmode="numeric"  /> <!--por ahora no requiere required /> -->
         ...
         <tr>
			...
			<select name=responsable Style="width=200px" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?> >
			  <option value='' <?if ($responsable=='') echo "selected"?>>Selecciones</option>
...
<tr>
  <td colspan="4" align="left" id="cdomi" style="display:<?=$cdomi1?>">
...
<tr>
  ...
  <td align='left'>
  <input type="text" size="30" value="<?=$numero_calle?>" name="numero_calle" onkeypress="return pulsar(event)" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
  </td>  
</tr>  
...
<tr>
  ...
  <td align='left'>
  <input type="text" size="30" value="<?=$piso?>" name="piso" onkeypress="return pulsar(event)" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>           
  </td>
  ...
  <td align='left'>
  <input type="text" size="30" value="<?=$dpto?>" name="dpto" onkeypress="return pulsar(event)" onblur="this.value=this.value.toUpperCase();" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
  </td>
</tr> 
...
<tr>        	
  ...
  <td align='left'>
  <input type="text" size="30" value="<?=$manzana?>" name="manzana" onkeypress="return pulsar(event)" onblur="this.value=this.value.toUpperCase();" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>         	
  </td>
</tr>
...
<tr>
  ...
  <td align='left'>
  <input type="text" size="30" value="<?=$entre_calle_1?>" name="entre_calle_1" onkeypress="return pulsar(event)" onblur="this.value=this.value.toUpperCase();" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
  </td>         	
  ...
  <td align='left'>
  <input type="text" size="30" value="<?=$entre_calle_2?>" name="entre_calle_2" onkeypress="return pulsar(event)" onblur="this.value=this.value.toUpperCase();" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>         	
  </td>         	
</tr>  
...
<td align='left'>
<input type="text" size="30" value="<?=$email?>" name="email" onkeypress="return pulsar(event)" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>          
</td>
</tr>
...
<br>
<? echo $clave_beneficiario."dato de la clave";
if  ($clave_beneficiario != '') {?>
  <table class="bordes" align="center" width="100%">
		 ...
		 <tr>
          ...
          <input type=button name="carga_remediar" value="Empadronar" onclick="window.open('<?=encode_link("../remediar/remediar_admin.php",array("estado_envio"=>$estado_envio,"clave_beneficiario"=>$clave_beneficiario,"sexo"=>$sexo,"fecha_nac"=>$fecha_nac,"vremediar"=>'s',"pagina_viene_1"=>"ins_admin_old.php"))?>','Remediar','dependent:yes,width=1000,height=700,top=1,left=60,scrollbars=yes');" title="Carga Remediar + Redes" <?if ($tipo_transaccion == "B") echo "disabled"?>>&nbsp;
          
          <input type=button class="btn btn-success" name="carga_test_findrisk" value="Test de Findrisk" onclick="window.open('<?=encode_link("../remediar/test_findrisk.php",array("estado_envio"=>$estado_envio,"clave_beneficiario"=>$clave_beneficiario,"sexo"=>$sexo,"fecha_nac"=>$fecha_nac,"vremediar"=>'s',"pagina_viene_1"=>"ins_admin_old.php"))?>','Remediar','dependent:yes,width=1000,height=700,top=1,left=60,scrollbars=yes');" title="Carga Remediar + Redes" <?if ($tipo_transaccion == "B") echo "disabled"?>>&nbsp;
		    </td>
		 </tr> 
	 </table>	
	 <br>
...
<?if ($id_planilla){?>
  <?php 
  //$id_paciente = $id_planilla;
  //$ficha_consumo_editable = false;
  //$ficha_consultas_collapsed = true;
  //include_once(MOD_DIR."/turnos/ficha_consumo.php");
  ?>
<?}?>
<div class="well text-center">
  <?php if (!empty($pagina_viene_1)){ ?>
   <button class="btn btn-primary" onclick="document.location='<?=$pagina_viene_1?>'; return false;">Volver</button>
  <?php } elseif (!empty($pagina_viene_2)){ ?>
   <button class="btn btn-primary" onclick="document.location='<?=$pagina_viene_2?>'; return false;">Volver</button>
  <?php } else  { ?>
   <button class="btn btn-primary" onclick="document.location='<?=$html_root?>/modulos/inscripcion/ins_listado_old.php'; return false;">Volver</button>
  <?php } ?>  
</div>
</div>
</form>
