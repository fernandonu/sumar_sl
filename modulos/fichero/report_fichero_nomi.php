...
if ($_POST['muestra']=="Muestra"){
	...
	//$sql_tmp = get_datos_fichero ($cuie,$fecha_desde,$fecha_hasta);	
...
<table class="table table-striped" border=1 width=100% cellspacing=2 cellpadding=2 bgcolor='<?php echo $bgcolor3?>' align=center>
  <tr>
  	<td colspan=17 align="left" id="ma">
     <table width=100% >
      <tr id="ma">
       <td width=30% align="left"><b>Total:</b> <?php echo $res_comprobante->recordCount()?> Filtro: <?php echo $_POST['periodo'];?></td>       
      </tr>
    </table>
   </td>
  </tr>
 ...
 <? while (!$res_comprobante->EOF) {?>  	
	...
	<td ><?php echo trim($res_comprobante->fields['afisexo']);?></td>	
	<?php 
		/*if ($res_comprobante->fields['afifechanac']!='' and $res_comprobante->fields['afifechanac']!=null
			and $res_comprobante->fields['fecha_comprobante']!='' and $res_comprobante->fields['fecha_comprobante']!=null
			and $res_comprobante->fields['afifechanac']<=$res_comprobante->fields['fecha_comprobante']
			) 
			{$edad = edad_con_meses($res_comprobante->fields['afifechanac'],$res_comprobante->fields['fecha_comprobante']);
			$edad = $edad['anos'];}
		else $edad = -1;*/
	?>	
	<td ><?php echo $res_comprobante->fields['edad_control_anios'].'A '.$res_comprobante->fields['edad_control_meses'].'M '.$res_comprobante->fields['edad_control_dias'].'D'?></td> 
