...
function control_entrada()
  {        
         if(document.all.varperiodo.value=='-1'){
          alert('Debe Ingresar el filtro de fecha del periodo');
          document.all.varperiodo.focus();
          return false;
         }
       ...
       if (document.all.cuie.value=='Seleccione') {
          alert('Debe Ingresar el Efector');
