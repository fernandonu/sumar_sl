...
if ($parametros) extract($parametros,EXTR_OVERWRITE);
 ...
 $str='where '.$var_periodo.' ::date between '."'".$fecha_desde."'".' and '."'".$fecha_hasta."'";
 ...
 $proyeccion="SELECT DISTINCT ON (uad.beneficiarios.numero_doc)
...
sip_clap.hcperinatal.var_0001 as Nombre3,
sip_clap.hcperinatal.var_0002 as Apellido,
sip_clap.hcperinatal.var_0003 as Domicilio2,
sip_clap.hcperinatal.var_0004 as Localidad2,
...
$result=sql($q) or fin_pagina();
    ...
    $filename = "Sipweb_".$cuie.".xls";
    $fecha_hoy = date("Y-m-d H:i:s");
    excel_header($filename);?>

<form name=form1 method=post action="sipweb_excel.php">

<?if ($cuie<>'todos'){
  $efe="SELECT * from nacer.efe_conv where cuie='$cuie'";
  $res_efe=sql($efe) or fin_pagina();
  ?>
...
<td align="left"><font color="blue"><?=utf8_decode($res_efe->fields['nombre'])?></font></td>
</tr>

<tr>
<td align="right"><b>Domicilio:</b></td>
<td align="left"><font color="blue"><?=utf8_decode($res_efe->fields['domicilio'])?></font></td>
</tr>

<tr>
<td align="right"><b>Departamento:</b></td>
<td align="left"><font color="blue"><?=$res_efe->fields['departamento']?></font></td>
</tr>
...
<td align="left"><font color="blue"><?=$res_efe->fields['localidad']?></font></td>
</tr>
</table>
</td>      
...
<td align="left"><font color="blue"><?=$res_efe->fields['cod_pos']?></font></td>
</tr>

<tr>
<td align="right"><b>Cuidad:</b></td>
<td align="left"><font color="blue"><?=$res_efe->fields['cuidad']?></font></td>
</tr>

<tr>
<td align="right"><b>Referente:</b></td>
<td align="left"><font color="blue"><?=utf8_decode($res_efe->fields['referente'])?></font></td>
</tr>

<tr>
<td align="right"><b>Telefono:</b></td>
<td align="left"><font color="blue"><?=$res_efe->fields['tel']?></font></td>
</tr>          
</table>
</td>  
</tr> 
    ...
    <table width="100%">
     ...
     <table width="100%" align=center border=1 bordercolor=#585858 cellspacing="0" cellpadding="7"> 
      <tr bgcolor=#C0C0FF>
        ...
        <td align="center" id=mo>departamento</td>
      ...
      while (!$result->EOF) {?>  
        ...
        <td><?=$result->fields['tbc_familiares']?></td>
        <td><?=$result->fields['diabetes_familiares']?></td>
        <td><?=$result->fields['hipertension_familiares']?></td>
        <td><?=$result->fields['antecedentes_preclampsia_familiares']?></td>
        <td><?=$result->fields['eclampsia_familiares']?></td>
        <td><?=$result->fields['otro_antecedente_familiar']?></td>
        <td><?=$result->fields['tbc_personales']?></td>
        <td><?=$result->fields['diabetes_personales']?></td>
        <td><?=$result->fields['hipertension_personales']?></td>
        <td><?=$result->fields['antecedentes_preclampsia_personales']?></td>
        <td><?=$result->fields['eclampsia_personales']?></td>
        <td><?=$result->fields['otro_antecedente_personal']?></td>
        <td><?=$result->fields['cirugia_personales']?></td>
        <td><?=$result->fields['infertilidad_personales']?></td>
        <td><?=$result->fields['cardiopatia_antecedentes']?></td>
        <td><?=$result->fields['antecedentes_Nefropatia']?></td>
        <td><?=$result->fields['violencia_personales']?></td>
        <td><?=$result->fields['otros_antecedentes']?></td>
        <td><?=$result->fields['gestas_previas']?></td>
        <td><?=$result->fields['abortos_previos']?></td>
        <td><?=$result->fields['tres_abortos_espontaneos_consecutivos']?></td>
        <td><?=$result->fields['partos_previos']?></td>
        <td><?=$result->fields['peso_RN_previo']?></td>
        <td><?=$result->fields['antecedentes_gemelares']?></td>
        <td><?=$result->fields['partos_vaginales']?></td>
        <td><?=$result->fields['cesareas_previas']?></td>
        <td><?=$result->fields['ant_nacidos_vivos']?></td>
        <td><?=$result->fields['rn_que_viven']?></td>
        <td><?=$result->fields['ant_nacidos_muertos']?></td>
        <td><?=$result->fields['ant_muertos_1a_sem']?></td>
        <td><?=$result->fields['ant_muertos_despues_1a_sem']?></td>
        <td><?=$result->fields['fecha_embarazo_anterior']?></td>
        <td><?=$result->fields['embarazo_anterior_menor_1']?></td>
        <td><?=$result->fields['embarazo_planeado']?></td>
        <td><?=$result->fields['fracaso_metodo_anticonceptivo']?></td>
        
        <td><?=$result->fields['peso_anterior']?></td>
        <td><?=$result->fields['talla_madre']?></td>
        <td><?=$result->fields['fecha_ultima_menstruacion']?></td>
        <td><?=$result->fields['fecha_probable_de_parto']?></td>
        <td><?=$result->fields['eg_confiable_por_fum']?></td>
        <td><?=$result->fields['eg_confiable_por_Eco_menor20s']?></td>
        <td><?=$result->fields['antirubeola']?></td>
        <td><?=$result->fields['antitetanica_vigente']?></td>
        <td><?=$result->fields['antitetanica_dosis_1']?></td>
        <td><?=$result->fields['antitetanica_dosis_2']?></td>
        <td><?=$result->fields['examen_odontologico_normal']?></td>
        <td><?=$result->fields['examen_mamas_normal']?></td>
        <td><?=$result->fields['cervix_insp_Visual']?></td>
        <td><?=$result->fields['cervix_PAP']?></td>
        <td><?=$result->fields['cervix_COLP']?></td>
        <td><?=$result->fields['grupo_sanguineo']?></td>
        <td><?=$result->fields['rh']?></td>
        <td><?=$result->fields['inmunizacion']?></td>
        <td><?=$result->fields['tamizaje_Antenatal_Toxoplasmosis_menor20_sem']?></td>
        <td><?=$result->fields['tamizaje_Antenatal_Toxoplasmosis_mayoIgual20_sem']?></td>
        <td><?=$result->fields['tamizaje_Antenatal_Toxoplasmosis_1er_Consulta']?></td>
        <td><?=$result->fields['hb_menor_20_sem']?></td>
        <td><?=$result->fields['hb_menor_20_sem_menor_11g']?></td>
        <td><?=$result->fields['hierro_indicado']?></td>
        <td><?=$result->fields['folatos_indicados']?></td>
        <td><?=$result->fields['hb_mayorigual20_sem']?></td>
        <td><?=$result->fields['hb_mayorigual20sem_menor_11g']?></td>
        <td><?=$result->fields['tamizaje_antenatal_chagas']?></td>
        <td><?=$result->fields['Tamizaje_Antenatal_Hepatitis_B']?></td>
        <td><?=$result->fields['bacteriuria_menor20sem']?></td>
        <td><?=$result->fields['bacteriuria_mayorigual20sem']?></td>
        <td><?=$result->fields['glucemia_menor20sem']?></td>
        <td><?=$result->fields['glumenor20sem_mayor_105']?></td>
        <td><?=$result->fields['glu_mayorigual30sem_mayor_105']?></td>
        <td><?=$result->fields['glucemia_mayorigual30sem']?></td>
        <td><?=$result->fields['tamizaje_antenatal_estreptococo_b']?></td>
        <td><?=$result->fields['preparacion_parto']?></td>
        <td><?=$result->fields['consejeria_lactancia']?></td>
        <td><?=$result->fields['tamizaje_antenatal_vih_menor20sem_solicitado']?></td>
        <td><?=$result->fields['tamizaje_antenatal_vih_moyorigual20sem_solicitado']?></td>
        <td><?=$result->fields['prueba_sifilis_no_treponemica_menor20s']?></td>
        <td><?=$result->fields['prueba_sifilis_no_treponemica_mayorigual20s']?></td>
        <td><?=$result->fields['tratamiento_sifilis_menor20s']?></td>

        <td><?=$result->fields['rn_sexo']?></td>
        <td><?=$result->fields['peso_al_nacer']?></td>
        <td><?=$result->fields['peso_al_nacer_menor2500o_mayorigual4000']?></td>
        <td><?=$result->fields['perimetro_cefalico']?></td>
        <td><?=$result->fields['longitud']?></td>
        <td><?=$result->fields['edad_gestacional_rn']?></td>
        <td><?=$result->fields['edad_gestacional_rn_dias']?></td>
        <td><?=$result->fields['edad_gestacional_rn_estimada']?></td>
        <td><?=$result->fields['edad_gestacional_rn_fum']?></td>
        <td><?=$result->fields['edad_gestacional_rn_eco']?></td>
        <td><?=$result->fields['rn_peso_para_edad_gestacional']?></td>
        <td><?=$result->fields['apgar_1erminuto']?></td>
        <td><?=$result->fields['apgar_5tominuto']?></td>
        <td><?=$result->fields['rn_reanimacion_estimulacion']?></td>
        <td><?=$result->fields['rn_reanimacion_aspiracion']?></td>
        <td><?=$result->fields['rn_reanimacion_mascara']?></td>
        <td><?=$result->fields['rn_reanimacion_oxigeno']?></td>
        <td><?=$result->fields['rn_reanimacion_masaje']?></td>
        <td><?=$result->fields['rn_reanimacion_tubo']?></td>
        <td><?=$result->fields['fallece_lugar_de_parto']?></td>
        <td><?=$result->fields['referido']?></td>
        <td><?=$result->fields['atendio_parto']?></td>
        <td><?=$result->fields['atendio_parto_nombre']?></td>
        <td><?=$result->fields['atendio_neonato']?></td>
        <td><?=$result->fields['atendio_neonato_nombre']?></td>
        <td><?=$result->fields['defectos_congenitos']?></td>
        <td><?=$result->fields['defectos_congenitos_codigo']?></td>
        <td><?=$result->fields['enfermedades_rn']?></td>
        <td><?=$result->fields['codigo_enfermedad_rn1']?></td>
        <td><?=$result->fields['notas_enfermedades_rn1']?></td>
        <td><?=$result->fields['codigo_enfermedad_rn2']?></td>
        <td><?=$result->fields['notas_enfermedades_rn2']?></td>
        <td><?=$result->fields['codigo_enfermedad_rn3']?></td>
        <td><?=$result->fields['notas_enfermedades_rn3']?></td>
        <td><?=$result->fields['rn_tamizaje_vdrl']?></td>
        <td><?=$result->fields['rn_tamizaje_tsh']?></td>
        <td><?=$result->fields['rn_tamizaje_hbpatia']?></td>
        <td><?=$result->fields['rn_tamizaje_bilirrubina']?></td>
        <td><?=$result->fields['rn_tamizaje_toxo_igm']?></td>
        <td><?=$result->fields['rn_tamizaje_meconio_1erdia']?></td>
        <td><?=$result->fields['antirubeola_postparto']?></td>
        <td><?=$result->fields['egreso_rn_hora']?></td>
        <td><?=$result->fields['egreso_rn']?></td>
        <td><?=$result->fields['lugar_traslado_rn']?></td>
        <td><?=$result->fields['fallece_lugar_de_traslado']?></td>
        <td><?=$result->fields['edad_egreso']?></td>
        <td><?=$result->fields['edad_menor1dia']?></td>
        <td><?=$result->fields['alimento_al_alta']?></td>
        <td><?=$result->fields['boca_arriba']?></td>
        <td><?=$result->fields['bcg']?></td>
        <td><?=$result->fields['peso_rn_al_egreso']?></td>
        <td><?=$result->fields['fecha_de_egreso_materno']?></td>
        <td><?=$result->fields['traslado']?></td>
        <td><?=$result->fields['lugar_traslado_materno']?></td>
        <td><?=$result->fields['egreso_materno']?></td>
        <td><?=$result->fields['fallece_durante_traslado']?></td>
        <td><?=$result->fields['fallece_durante_traslado_dias']?></td>
        <td><?=$result->fields['anticoncepcion_consejeria']?></td>
        <td><?=$result->fields['metodo_antic_elegido']?></td>
        <td><?=$result->fields['nro_historia_rn']?></td>
        <td><?=$result->fields['nombre_rn']?></td>
        <td><?=$result->fields['responsable_egreso_rn']?></td>
        <td><?=$result->fields['responsable_egreso_materno']?></td>
        <td><?=$result->fields['vih_personales']?></td>
        <td><?=$result->fields['embarazo_ectopico']?></td>
        <td><?=$result->fields['fumadora_activa_1er']?></td>
        <td><?=$result->fields['fumadora_pasiva_1er']?></td>
        <td><?=$result->fields['drogas_1er']?></td>
        <td><?=$result->fields['alcohol_1er']?></td>
        <td><?=$result->fields['violencia_1er']?></td>
        <td><?=$result->fields['fumadora_activa_2do']?></td>
        <td><?=$result->fields['fumadora_pasiva_2do']?></td>
        <td><?=$result->fields['drogas_2do']?></td>
        <td><?=$result->fields['alcohol_2do']?></td>
        <td><?=$result->fields['violencia_2do']?></td>
        <td><?=$result->fields['fumadora_activa_3er']?></td>
        <td><?=$result->fields['fumadora_pasiva_3er']?></td>
        <td><?=$result->fields['drogas_3er']?></td>
        <td><?=$result->fields['alcohol_3er']?></td>
        <td><?=$result->fields['violencia_3er']?></td>
        <td><?=$result->fields['gamma_globulina_anti_d']?></td>
        <td><?=$result->fields['tamizaje_antenatal_prueba_vih_menor20sem']?></td>
        <td><?=$result->fields['tamizaje_antenatal_tarv_vih_menor20sem']?></td>
        <td><?=$result->fields['tamizaje_antenatal_prueba_vih_mayorigual20sem']?></td>
        <td><?=$result->fields['tamizaje_antenatal_tarv_vih_mayorigual20sem']?></td>
        <td><?=$result->fields['semana_prueba_sifilis_no_trepon_menor20s']?></td>
        <td><?=$result->fields['semana_prueba_sifilis_no_trepon_mayorigual20s']?></td>
        <td><?=$result->fields['prueba_sifilis_treponemica_menor20s']?></td>
        <td><?=$result->fields['semana_prueba_sifilis_treponemica_menor20s']?></td>
        <td><?=$result->fields['semana_prueba_sifilis_treponemica_mayorigual20s']?></td>
        <td><?=$result->fields['prueba_sifilis_treponemica_mayorigual20s']?></td>
        <td><?=$result->fields['semana_tratamiento_sifilis_menor20s']?></td>
        <td><?=$result->fields['semana_tratamiento_sifilis_mayorigual20s']?></td>
        <td><?=$result->fields['tratamiento_sifilis_mayorigual20s']?></td>
        <td><?=$result->fields['tratamiento_sifilis_pareja_menor20s']?></td>
        <td><?=$result->fields['egreso_rn_fecha']?></td>
        <td><?=$result->fields['tdp_prueba_sifilis']?></td>
        <td><?=$result->fields['tdp_prueba_vih']?></td>
        <td><?=$result->fields['vih_en_rn_expuesto']?></td>
        <td><?=$result->fields['vih_en_rn_tratamiento']?></td>
        <td><?=$result->fields['tto_vdrl']?></td>
        <td><?=$result->fields['gamma_globulina_anti_d_egreso']?></td>

        <td><?=$result->fields['usuario_carga']?></td>
        <td><?=$result->fields['fecha_hora_carga']?></td>
        <td><?=$result->fields['fecha_hora_proceso']?></td>
        <td><?=$result->fields['finalizado']?></td>
        <td><?=$result->fields['estado']?></td>

        <td><?=$result->fields['parto_aborto']?></td>
        <td><?=$result->fields['fecha_de_ingreso']?></td>
        <td><?=$result->fields['carne']?></td>
        <td><?=$result->fields['consultas_prenatales']?></td>
        <td><?=$result->fields['hospitalizacion']?></td>
        <td><?=$result->fields['hospitalizacion_dias']?></td>
        <td><?=$result->fields['corticoides']?></td>
        <td><?=$result->fields['corticoides2']?></td>
        <td><?=$result->fields['inicio_parto']?></td>
        <td><?=$result->fields['ruptura_de_membranas']?></td>
        <td><?=$result->fields['fecha_ruptura_de_membranas']?></td>
        <td><?=$result->fields['hora_rupt_membranas']?></td>
        <td><?=$result->fields['rupt_membranas_menor_37sem']?></td>
        <td><?=$result->fields['rupt_membranas_mayorigual_18hs']?></td>
        <td><?=$result->fields['rupt_membranas_temperatura_mayorigual_38']?></td>
        <td><?=$result->fields['rupt_membranas_temperatura']?></td>
        <td><?=$result->fields['edad_gestacional_al_parto']?></td>
        <td><?=$result->fields['edad_gestacional_dias']?></td>
        <td><?=$result->fields['edad_gestacional_al_parto_por_fum']?></td>
        <td><?=$result->fields['edad_gestacional_al_parto_por_eco']?></td>
        <td><?=$result->fields['presentacion_situacion']?></td>
        <td><?=$result->fields['tamaño_fetal_acorde']?></td>
        <td><?=$result->fields['acompañante_tdp']?></td>
        <td><?=$result->fields['acompañante_parto']?></td>
        <td><?=$result->fields['trabajo_de_parto_detalles']?></td>
        <td><?=$result->fields['enfermedades']?></td>
        <td><?=$result->fields['hta_previa']?></td>
        <td><?=$result->fields['hta_inducida']?></td>
        <td><?=$result->fields['preeclampsia']?></td>
        <td><?=$result->fields['eclampsia']?></td>
        <td><?=$result->fields['cardiopatia']?></td>
        <td><?=$result->fields['nefropatia']?></td>
        <td><?=$result->fields['diabetes']?></td>
        <td><?=$result->fields['infeccion_ovular']?></td>
        <td><?=$result->fields['infeccion_urinaria']?></td>
        <td><?=$result->fields['amenaza_parto_pretermino']?></td>
        <td><?=$result->fields['rciu']?></td>
        <td><?=$result->fields['ruptura_prem_de_membranas']?></td>
        <td><?=$result->fields['anemia']?></td>
        <td><?=$result->fields['otra_condicion_grave']?></td>
        <td><?=$result->fields['hemorragia_1er_trim']?></td>
        <td><?=$result->fields['hemorragia_2do_trim']?></td>
        <td><?=$result->fields['hemorragia_3er_trim']?></td>
        <td><?=$result->fields['hemorragia_posparto']?></td>
        <td><?=$result->fields['infeccion_purperal']?></td>
        <td><?=$result->fields['codigo_enfermedad_1']?></td>
        <td><?=$result->fields['codigo_enfermedad_2']?></td>
        <td><?=$result->fields['codigo_enfermedad_3']?></td>
        <td><?=$result->fields['nacimiento']?></td>
        <td><?=$result->fields['hora_nacimiento']?></td>
        <td><?=$result->fields['fecha_de_nacimiento']?></td>
        <td><?=$result->fields['embarazo_multiple']?></td>
        <td><?=$result->fields['embarazo_multiple_orden']?></td>
        <td><?=$result->fields['terminacion']?></td>
        <td><?=$result->fields['motivo_principal_de_induccion_o_cirugia']?></td>
        <td><?=$result->fields['codigo_inducción']?></td>
        <td><?=$result->fields['codigo_operatorio']?></td>
        <td><?=$result->fields['posicion_parto']?></td>
        <td><?=$result->fields['episiotomia']?></td>
        <td><?=$result->fields['desgarros_no']?></td>
        <td><?=$result->fields['desgarros_grado']?></td>
        <td><?=$result->fields['ocitocicos_prealumbramiento']?></td>
        <td><?=$result->fields['vit_k']?></td>
        <td><?=$result->fields['placenta_completa']?></td>
        <td><?=$result->fields['placenta_retenida']?></td>
        <td><?=$result->fields['ligadura_cordon_precoz']?></td>
        <td><?=$result->fields['ocitócicos_en_tdp']?></td>
        <td><?=$result->fields['antibióticos']?></td>
        <td><?=$result->fields['analgesia']?></td>
        <td><?=$result->fields['anestesia_local']?></td>
        <td><?=$result->fields['anestesia_regional']?></td>
        <td><?=$result->fields['anestesia_general']?></td>
        <td><?=$result->fields['transfusion']?></td>
        <td><?=$result->fields['otros']?></td>
        <td><?=$result->fields['codigo_medicacion1']?></td>
        <td><?=$result->fields['codigo_medicacion2']?></td>

        <td><?=$result->fields['procesado']?></td>
        <td><?=$result->fields['usuario_ultact']?></td>
        <td><?=$result->fields['fecha_hora_ultact']?></td>
        <td><?=$result->fields['score_riesgo']?></td>

        <td><?=$result->fields['control_en_parto_1_hora']?></td>
        <td><?=$result->fields['control_en_parto_1_minutos']?></td>
        <td><?=$result->fields['control_en_parto_1_posicion']?></td>
        <td><?=$result->fields['control_en_parto_1_pasist']?></td>
        <td><?=$result->fields['control_en_parto_1_padiast']?></td>
        <td><?=$result->fields['control_en_parto_1_pulso']?></td>
        <td><?=$result->fields['control_en_parto_1_contracciones10']?></td>
        <td><?=$result->fields['control_en_parto_1_dilatacion']?></td>
        <td><?=$result->fields['control_en_parto_1_altura_pres']?></td>
        <td><?=$result->fields['control_en_parto_1_variacion_posicion']?></td>
        <td><?=$result->fields['control_en_parto_1_meconio']?></td>
        <td><?=$result->fields['control_en_parto_1_fcf_dips']?></td>

        <td><?=$result->fields['control_post_parto_1_dia']?></td>
        <td><?=$result->fields['control_post_parto_1_hora']?></td>
        <td><?=$result->fields['control_post_parto_1_temp_grados']?></td>
        <td><?=$result->fields['control_post_parto_1_pa_sist']?></td>
        <td><?=$result->fields['control_post_parto_1_diast']?></td>
        <td><?=$result->fields['control_post_parto_1_pulso']?></td>
        <td><?=$result->fields['control_post_parto_1_invol_uter']?></td>
        <td><?=$result->fields['control_post_parto_1_loquios']?></td>
        ...
        <td><?=$result->fields['violencia_3er']?></td>
        <td><?=$result->fields['gamma_globulina_anti_d']?></td>
        <td><?=$result->fields['tamizaje_antenatal_prueba_vih_menor_20sem']?></td>
        <td><?=$result->fields['tamizaje_antenatal_tarv_vih_menor_20sem']?></td>
        <td><?=$result->fields['tamizaje_antenatal_prueba_vih_mayor_igual_20sem']?></td>
        <td><?=$result->fields['semana_prueba_sifilis_no_trepon_menor_20s']?></td>
        <td><?=$result->fields['semana_prueba_sifilis_no_trepon_mayor_igual_20s']?></td>
        <td><?=$result->fields['prueba_sifilis_treponemica_menor_20s']?></td>
        <td><?=$result->fields['semana_prueba_sifilis_treponemica_menor_20s']?></td>
        <td><?=$result->fields['semana_prueba_sifilis_treponemica_mayor_igual_20s']?></td>
        <td><?=$result->fields['prueba_sifilis_treponemica_mayor_igual_20s']?></td>
        <td><?=$result->fields['semana_tratamiento_sifilis_menor_20s']?></td>
        <td><?=$result->fields['semana_tratamiento_sifilis_mayor_igual_20s']?></td>
        <td><?=$result->fields['tratamiento_sifilis_mayor_igual_20s']?></td>
        <td><?=$result->fields['tratamiento_sifilis_pareja_menor_20s']?></td>
        <td><?=$result->fields['tratamiento_sifilis_pareja_mayor_igual_20s']?></td>
        <td><?=$result->fields['tdp_prueba_sifilis']?></td>
        <td><?=$result->fields['tdp_prueba_vih']?></td>
        <td><?=$result->fields['tdp_arv']?></td>
        <td><?=$result->fields['vih_en_rn_expuesto']?></td>
        <td><?=$result->fields['vih_en_rn_tratamiento']?></td>
        <td><?=$result->fields['tto_vdrl']?></td>
        <td><?=$result->fields['gamma_globulina_anti_d_egreso']?></td>
        ...
        <td><?=$result->fields['vit_k']?></td>
        <td><?=$result->fields['imc']?></td>
        <td><?=$result->fields['libre_2']?></td>
        <td><?=$result->fields['libre_3']?></td>
        <td><?=$result->fields['libre_4']?></td>
        <td><?=$result->fields['libre_5']?></td>
        <td><?=$result->fields['libre_6']?></td>
        <td><?=$result->fields['libre_7']?></td>
        <td><?=$result->fields['libre_8']?></td>
        <td><?=$result->fields['libre_9']?></td>
        <td><?=$result->fields['libre_10']?></td>
        <td><?=$result->fields['libre_11']?></td>
        <td><?=$result->fields['libre_12']?></td>
        <td><?=$result->fields['libre_13']?></td>
        <td><?=$result->fields['libre_14']?></td>
        <td><?=$result->fields['libre_15']?></td>
        ...
        <td><?=$result->fields['edad_gestacional_rn_eco']?></td>
        <td><?=$result->fields['rn_peso_para_edad_gestacional']?></td>
        <td><?=$result->fields['apgar_1er_minuto']?></td>
        <td><?=$result->fields['apgar_5to_minuto']?></td>
        <td><?=$result->fields['rn_reanimacion_estimulacion']?></td>
        <td><?=$result->fields['rn_reanimacion_aspiracion']?></td>
        <td><?=$result->fields['rn_reanimacion_mascara']?></td>
        <td><?=$result->fields['rn_reanimacion_oxigeno']?></td>
        ...
        <td><?=$result->fields['defectos_congenitos_codigo']?></td>
        <td><?=$result->fields['enfermedades_rn']?></td>
        <td><?=$result->fields['codigo_enfermedad_rn_1']?></td>
        <td><?=$result->fields['notas_enfermedades_rn_1']?></td>
        <td><?=$result->fields['codigo_enfermedad_rn_2']?></td>
        <td><?=$result->fields['notas_enfermedades_rn_2']?></td>
        <td><?=$result->fields['codigo_enfermedad_rn_3']?></td>
        <td><?=$result->fields['notas_enfermedades_rn_3']?></td>
        <td><?=$result->fields['rn_tamizaje_vdrl']?></td>
        <td><?=$result->fields['rn_tamizaje_tsh']?></td>
        <td><?=$result->fields['rn_tamizaje_hbpatia']?></td>
        <td><?=$result->fields['rn_tamizaje_bilirrubina']?></td>
        <td><?=$result->fields['rn_tamizaje_toxo_igm']?></td>
        <td><?=$result->fields['rn_tamizaje_meconio_1er_dia']?></td>
        <td><?=$result->fields['antirubeola_postparto']?></td>
        <td><?=$result->fields['egreso_rn_fecha']?></td>
        <td><?=$result->fields['egreso_rn_hora']?></td>
        <td><?=$result->fields['egreso_rn']?></td>
