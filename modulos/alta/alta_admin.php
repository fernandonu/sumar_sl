...
echo $ret;
  ...
  //enviar_mail_html('seba1202@gmail.com','Notificacion ALTA CONJUNTA',$ret,0,0,0);
  enviar_mail_html('alenoe.rodri91@gmail.com','Notificacion ALTA CONJUNTA',$ret,0,0,0);
  ...
  <table width=90% align="center" class="bordes">
     ...
     <tr>
      ...
      <td align="left">       
       ...
       while (!$res_efectores->EOF){ 
        $cuiel=$res_efectores->fields['cuie'];
          ...
          ?>
        <option value='<?php echo $cuiel?>' <?if ($cuie==$cuiel) echo "selected"?> ><?php echo $nombre_efector?></option>
          <?
      ...
      <td align="left">       
       ...
       while (!$res_efectores->EOF){ 
        $cuiel=$res_efectores->fields['cuie'];
          ...
          ?>
        <option value='<?php echo $cuiel?>' <?if ($cuie_at_hab==$cuiel) echo "selected"?> ><?php echo $nombre_efector?></option>
          <?
          $res_efectores->movenext();
          }?>
      </select>
      ...
      <td align="right">
        ...
        <td align="left">         
           <input type=text id=fecha_alta name=fecha_alta value='<?php echo fecha($fecha_alta);?>' size=15 readonly>
           <?php echo link_calendario("fecha_alta");?>                 
        </td>       
    </tr>
    ...
    <tr>
      <td align="right">
        ...
        <td align="left">         
           <input type=text id=fecha_parto name=fecha_parto value='<?php echo fecha($fecha_parto);?>' size=15 readonly>
           <?php echo link_calendario("fecha_parto");?>                
        </td>       
    </tr>
         ...
         <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="40" value="<?php echo $doc_madre?>" name="doc_madre" <? if ($id_planilla) echo "readonly"?>><font color="Red">Sin Puntos</font>
            </td>
         </tr>
         ...
         <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="40" value="<?php echo $nom_madre?>" name="nom_madre" <? if ($id_planilla) echo "readonly"?>>
            </td>
         </tr> 
         ...
         <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="40" value="<?php echo $nom_bebe?>" name="nom_bebe" <? if ($id_planilla) echo "readonly"?>>
            </td>
         </tr>
         ...
         <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="40" value="<?php echo $domicilio?>" name="domicilio" <? if ($id_planilla) echo "readonly"?>>
            </td>
         </tr> 
      ...
      <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="40" value="<?php echo $rep_obstetricia?>" name="rep_obstetricia" <? if ($id_planilla) echo "readonly"?>>
            </td>
         </tr>
         ...
         <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="40" value="<?php echo $rep_neo?>" name="rep_neo" <? if ($id_planilla) echo "readonly"?>>
            </td>
         </tr>
         ...
         <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="40" value="<?php echo $rep_enf?>" name="rep_enf" <? if ($id_planilla) echo "readonly"?>>
            </td>
         </tr>
       ...
       <tr>
          <td align="right">
            ...
            <td align="left">    
              <input type="checkbox" name="llena_epi" <?php echo ($llena_epi=="SI")?"checked":""?>>
            </td>
         </tr> 
         ...
         <tr>
          <td align="right">
            ...
            <td align="left">    
              <input type="checkbox" name="carnet_parenteral" <?php echo ($carnet_parenteral=="SI")?"checked":""?>>
            </td>
         </tr> 
         ...
         <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="20" value="<?php echo $peso_nacer?>" name="peso_nacer" <? if ($id_planilla) echo "readonly"?>><font color="Red">En Gramos.</font>
            </td>
        </tr>  
      ...
      <td align="left">       
        ...
        <option value='resultado_pendiente' <?if ($toxo=='resultado_pendiente') echo "selected"?>>Resultado Pendiente</option>       
         ...
         <tr>
          <td align="right">
            ...
            <td align="left">    
              <input type="checkbox" name="pes_neonatal" <?php echo ($pes_neonatal=="SI")?"checked":""?>>
            </td>
         </tr> 
       ...
       <tr>
          <td align="right">
            ...
            <td align="left">    
              <input type="checkbox" name="vac_hep_b" <?php echo ($vac_hep_b=="SI")?"checked":""?>>
            </td>
         </tr>    
         ...
         <tr>
          <td align="right">
            ...
            <td align="left">    
              <input type="checkbox" name="vac_bcg" <?php echo ($vac_bcg=="SI")?"checked":""?>>
            </td>
         </tr>   
        ...
        <option value='O-' <?if ($grupo_factor_bebe=='O-') echo "selected"?>>O-</option>
         ...
         <tr>
          <td align="right">
            ...
            <td align="left">    
              <input type="checkbox" name="gamma_anti_rh" <?php echo ($gamma_anti_rh=="SI")?"checked":""?>>
            </td>
         </tr>
       ...
       <select name=cuidados_puerpe Style="width=257px" <?if ($id_planilla) echo "disabled"?>>
        ...
        <option value='Escrita' <?if ($cuidados_puerpe=='Escrita') echo "selected"?>>Escrita</option>       
          ...
          <td align="right">
            ...
            <td align="left">    
              <input type="checkbox" name="control_postparto" <?php echo ($control_postparto=='SI')?"checked":""?>><font color="Red"> Refiere a si se controlo y registro en HC al menos 3 controles durante las primeras dos horas posteriores al parto, con registrode temperatura, pulso, TA, involucion uterina y caracteristicas de loquios</font>
            </td>
         </tr>
         <tr>
          <td id=mo colspan="2">
      ...
      <td align="left">       
       ...
       while (!$res_efectores->EOF){ 
        $cuiel=$res_efectores->fields['cuie'];
          $nombre_efector=$res_efectores->fields['nombre'];
          ?>
        <option value='<?php echo $cuiel?>' <?if ($cuie_ef_der==$cuiel) echo "selected"?> ><?php echo $nombre_efector?></option>
          <?
          $res_efectores->movenext();
          }?>
      </select>
      ...
      <td align="right">
        ...
        <td align="left"> 
           <input type=text id=fecha_turno name=fecha_turno value='<?php echo fecha($fecha_turno);?>' size=15 readonly>
           <?php echo link_calendario("fecha_turno");?>                
        </td>       
    </tr>
    <tr>
          <td align="right">
            ...
            <td align='left'>
              <input type="text" size="40" value="<?php echo $hora_turno?>" name="hora_turno" <? if ($id_planilla) echo "readonly"?>>
            </td>
         </tr>
       ...
       <tr>
         ...
         <tr>
          <td align="right">
            ...
            <td align='left'>
              <textarea cols='40' rows='4' name='observaciones' <? if ($id_planilla) echo "readonly"?>><?php echo $observaciones;?></textarea>
            </td>
         </tr>              
        </table>
      </td>      
