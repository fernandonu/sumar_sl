   		...
   		$("#id_prestacion option:selected").each(function () {
			//alert($(this).val());
				...
				if (id_prestacion!=21){
				  ...
				  if (!(id_prestacion>=22 && id_prestacion<=27)) {
					$("#precio").val("0.00");
          			document.all.precio.disabled=true;
		   			$.ajax({
...
<table class="bordes" align="center" width="70%" bordercolor=#E0E0E0 border="solid 1px ">
		 ...
		 <tr><td class="bordes"><table>
			...
			<tr>
					    ...
					    <td align="left">		          			
				 			<input type="text" name=id_diagnostico id="id_diagnostico" Style="width=600px"
				 			placeholder="Ingrese el codigo de diag." value='<?$id_diagnostico?>'>
			     		</td>
					 </tr>
			</table>
		</td>
