...
/*include_once("../nacer/secure/securimage.php");
$img = new Securimage();
...
<table cellspacing=2 cellpadding=2 border=0 width=100% align=center>
     <tr>
      	<td align=center>
         	...
         	<!--Codigo de la Imagen: 
          <input type="text" name="code" size="12" maxlength="6"/>
          &nbsp;&nbsp;-->
  ...
  <tr>
      	<td align=center>      
      		<img id="siimage" src="../nacer/secure/securimage_show.php" />
      		<a tabindex="-1" href="#" title="Cambiar Imagen" onclick="document.getElementById('siimage').src = '../nacer/secure/securimage_show.php?' + Math.random(); return false"><img src="../nacer/secure/images/refresh.png" alt="Cambiar Imagen" border="0" onclick="this.blur()" align="bottom" /></a>
      	</td>
  </tr>
	-->  
</table>
