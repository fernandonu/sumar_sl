   ...
   $id_beneficiarios=0;
   	$query="insert into trazadorassps.trazadora_13	
        ...
        '$diag',
			  ...
			  --'$ganglios_linfaticos',
			  --'$metastasis',
             '$fecha_carga','$usuario','$comentario_trz13',$id_beneficiarios)";
...
//		 }
//if(document.all.fecha_inic_tratamiento_trz13.value==""){
//	document.all.fecha_inic_tratamiento_trz13.value="01-01-1900";
//	  return true;
//	 }
...
<table class="bordes" align="center" width="100%">
  ...
  <tr align="left">
   <td>
   	<font size="2">Trazadora VII (DIAGNOSTICO DEL CANCER DE MAMA).</font>
   </td>
  </tr>
