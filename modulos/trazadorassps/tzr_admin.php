...
$Revision: 2.00 $
$Date: 2016/27/09 $
update segun nuevas modificaciones sobre el reporte de trazadoras Septiembre/2016
*/
...
if ($_POST['guardar']=="Guardar Planilla Trazadora 12"){
   ...
   $diag_trz12=$_POST['diag_trz12'];
   $fecha_inic_tratamiento_trz12=($_POST['fecha_inic_tratamiento_trz12']=='')?'1900-01-01':Fecha_db($_POST['fecha_inic_tratamiento_trz12']);
 ...
 if ($entidad_alta=='na'){ //smiafiliados
    ...
    $query="insert into trazadorassps.trazadora_12	
             (id_trz12,cuie,id_smiafiliados,fecha_nac,
			  ...
			  fecha_inic_tratamiento, 
             fecha_carga,usuario,comentario,id_beneficiarios)
             values
             ('$id_planilla','$cuie','$id','$fecha_nac_trz12',
              '$fecha_diagnostico_trz12','$diag_trz12',
			  '$fecha_inic_tratamiento_trz12',
...
{ 
	 if(document.all.cuie.value==""){
		  alert('Debe Ingresar el CUIE del efector');
		  return false;
		 }
	 ...
	 if(document.all.diag_trz12.value==-1){
		  alert('Debe Ingresar el Diagnostico');
		  return false;
		 }

	 if(document.all.fecha_inic_tratamiento_trz12.value==""){
...
{ 
	...
	if(document.all.diag_trz13.value=="-1"){
		  alert('Debe Ingresar el Diagnostico');
		  return false;
		 }
...
<tr>
           ...
           <td align="left">			 	
			 <select name=diag_trz12 Style="width=160px">
        		<option value=-1>Seleccione</option>
		...
		<!-- <tr>
		  ...
		  <tr>
		    ...
		    <td align="left">
		    	 ...
		    	 <input type=text id=fecha_inic_tratamiento_trz12 name=fecha_inic_tratamiento
 ...
 <tr><td><table width="100%" class="bordes" align="center">
  ...
  <tr><td><table id="trazadora13" width=90% align="center" class="bordes" style="display:none;border:thin groove">
		...
		<tr>
           <td align="right">
         	  <b> Resultado de Biopsia:
         	</td> 
           <td align="left">			 	
			 <select name=diag_trz13 Style="width=160px">
        		<option value=-1>Seleccione</option>
        		<option value="2">Carcinoma in Situ</option>
        		<option value="3">Carcinoma Invasor</option>
        	</select>
			</td>
          </tr>
