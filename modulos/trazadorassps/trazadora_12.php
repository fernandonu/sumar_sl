...
if ($_POST['guardar']=="Guardar Planilla"){
   ...
   //$inf_anat_patologica=$_POST['inf_anat_patologica'];
   //$inf_diag_biopsia=$_POST['inf_diag_biopsia'];       
   ...
   $id_planilla=$id_planilla->fields['id_planilla'];
    ...
    $query="INSERT into trazadorassps.trazadora_12	
             ...
             inf_anat_patologica,inf_diag_biopsia)
             values
          ('$id_planilla','$cuie',$id_smiafiliados,'$fecha_nac_trz12',
           '$fecha_diagnos','$diag','$fecha_inic_tratamiento',
           '$fecha_carga','$usuario','$comentario_trz12',$id_beneficiarios,
            0,0)";
...
if(document.all.diag.value==-1){
 ...
 if(document.all.fecha_inic_tratamiento.value==""){
	  alert('Debe Ingresar Fecha de Inicio de Tratamiento');
	  return false;
	 }
//if(document.all.inf_anat_patologica.value==-1){
//      alert('Debe Ingresar el Diagnostico');
//      return false;

//if(document.all.inf_diag_biopsia.value==-1){
//      alert('Debe Ingresar el Diagnostico');
//      return false;      
  ...
  <table width=90% align="center" class="bordes">
    ...
    <td align="left">			 	
		<select name=diag Style="width=160px">
        		<option value=-1>Seleccione</option>
        		<option value=4>Displasia moderada/CIN2/HSIL</option>
        		<option value=5>Displasia severa/CIN3/HSIL</option>
        		<option value=6>Carcinoma in situ</option>
        		<option value=7>carcinoma invasivo</option>
        </select>
		</td>
    </tr>	
    ...
    <!--<tr>
    <td align="right">
    <b> Inf.o Trasc.de Estudio Solicitado:</b>
    </td> 
    <td align="left">        
    <select name="inf_anat_patologica" Style="width=160px">
    <option value=-1>Seleccione</option>
            <option value=1>Insitu</option>
            <option value=2>invasor</option>
            <option value=3>Oculto</option>
            <option value=4>Otro CA</option>
            <option value=5>Preneoplasica</option> 
            <option value=6>Benigno</option>
            <option value=7>Insatisfactorio</option>     
    </select>
    </td>
    </tr>
    ...
    <tr>
    <td align="right">
    <b> Inf.o Trasc.de Diagnostico por Biopsia:</b>
    </td> 
    <td align="left">        
    <select name="inf_diag_biopsia" Style="width=160px">
      <option value=-1>Seleccione</option>
            <option value=1>H-Sil</option>
            <option value=2>CIN</option>
            <option value=3>CIN3</option>
            <option value=4>CIS-Carcinoma In Situ</option>
            <option value=5>Cancer Cervicouterino</option> 
            <option value=6>Lesion de Bajo Grado (CIN1,L-SIL)</option>
            <option value=7>Sin Lesion</option>     
    </select>
    </td>
    </tr>
    -->
