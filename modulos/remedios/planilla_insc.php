...
if($id_planilla){
	$queryCategoria="SELECT beneficiarios.*, efectores.nombre, efectores.cuie
...
$query="SELECT beneficiarios.*, efectores.nombre, efectores.cuie
			FROM uad.beneficiarios
			left join remedios.efectores on beneficiarios.cuie_ea=efectores.cuie 
  where id_beneficiarios=$id_planilla";
...
<form name='form1' action='planilla_insc.php' accept-charset="latin1" method='POST'>
		...
		<tr>
         ...
         <tr>
		    ...
		    <td align="left" colspan="2">
		    	 <input type=text name=fecha_inscripcion id=fecha_inscripcion onblur="esFechaValida(this);" value='<?=$fecha_inscripcion;?>' size=15 onkeypress="return pulsar(event)" <?php if ($id_planilla)echo "disabled"?>>
				 <?php if (!$id_planilla) {?>
         ...
         <tr>
			...
			/* $sql= " select remedios.efectores.nombreefector, remedios.efectores.cuie from remedios.efectores join sistema.usu_efec on (remedios.efectores.cuie = sistema.usu_efec.cuie) 
              ...
              <div id="ficha_consumo" class="panel-collapse collapse">
                <div class="panel-body text-center">
                  <table class="table table-condensed table-hover">
                    <thead>
                      <tr>
                        <th width="20%" class="small">M&eacute;dico</th>
                        <th width="20%" class="small">Especialidad</th>
                        <th width="30%" class="small">Diagn&oacute;stico</th>
                        <th width="20%" class="small">Evoluci&oacute;n</th>
                    ...
                    <tbody>
                      <?php
                      $query = "SELECT 
                                  nacer.cie10.dec10 AS diagnostico,
                                ...
                                WHERE
                                  nacer.agendas_eventos.id_paciente = 267
                                ORDER BY
                      ...
                      if ($res_ficha->recordCount() > 0) {
                        while (!$res_ficha->EOF) {
                          ...
                          echo '<td>', $res_ficha->fields['diagnostico'], '</td>';
...
<table class="bordes" align="center" width="100%">
 ...
 <tr><td><table width=100% align="center" class="bordes">
  <tr align="center">
   <td>
   	 <input type=button name="volver" value="Volver" onclick="document.location='listado_insc_remediar.php'"title="Volver al Listado" style="width=150px">     
 	</td>
  </tr>
