...
$res_medico=sql($sql) or fin_pagina();
	 ?>
					<script>
...
<?
			while (!$res_medico->EOF){ if(rtrim($res_medico->fields['dni_medico'])==''){$dni_medico='S/D';}else{$dni_medico=rtrim($res_medico->fields['dni_medico']);}?>
					<tr>
					<td>&nbsp;<a href="#" onclick="opener.document.forms.form1.dni_medico.value = '<?=$dni_medico?>'; opener.document.forms.form1.nombre_medico.value = '<?=$res_medico->fields['nombre_medico']?>'; opener.document.forms.form1.apellido_medico.value = '<?=$res_medico->fields['apellido_medico']?>';opener.document.forms.form1.id_medico.value = '<?=$res_medico->fields['id_medico']?>';opener.document.forms.form1.dni_medico.readOnly = true; opener.document.forms.form1.nombre_medico.readOnly = true; opener.document.forms.form1.apellido_medico.readOnly = true; window.close();" style="text-decoration:none;"><font size=2><?=$dni_medico?></font></a></td>
					<td>&nbsp;<font size=2><? echo $res_medico->fields['apellido_medico']; ?></font>&nbsp;</td>
                    <td>&nbsp;<font size=2><?=$res_medico->fields['nombre_medico']?></font>&nbsp;</td>
			<? $res_medico->movenext();
			    }?> </table>
