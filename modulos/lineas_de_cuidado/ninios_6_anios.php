...
limpiar_tablas('ninios_6_anio','hist_ninios_6_anio');
...
function busqueda_pres_madre($descripcion,$st_codigo,$st_fecha,$st_cuie,$tipo_linea,$fecha_desde,$fecha_hasta,$cuie){
 ...
 if ($cuie=="todos") {
     $sql_1="SELECT comprobante.id_smiafiliados,prestacion.fecha_prestacion,comprobante.cuie,
      ...
      and extract (year from (age(fecha_prestacion,fecha_nacimiento)))<7
...
if ($res_sql->recordcount() > 0){
  ...
  while (!$res_sql->EOF) {
        ...
        if (!se_encuentra($id_smiafiliados,$tipo_linea,'ninios_6_anio')) {
        $sql_2="SELECT nextval ('cobertura_efectiva.ninios_6_anio_id_seq') as id";
        $res_sql_2=sql($sql_2,"error al traer el id de la tabla de ninios menores de 1 anio");
        $id=$res_sql_2->fields['id'];
        
        $sql_insert="INSERT into cobertura_efectiva.ninios_6_anio
        ...
        $sql_2="SELECT nextval ('cobertura_efectiva.hist_ninios_6_anio_id_seq') as id";
        $res_sql_2=sql($sql_2,"error al traer el id de la tabla historica de ninios menores de 1 anio");
        $id_hist=$res_sql_2->fields['id'];
        
        $sql_insert="INSERT into cobertura_efectiva.hist_ninios_6_anio
        ...
        $sql_update="UPDATE cobertura_efectiva.ninios_6_anio
        ...
        $sql_consulta="SELECT id from cobertura_efectiva.ninios_6_anio 
                        WHERE id_smiafiliados=$id_smiafiliados and tipo_linea='$tipo_linea'";
...
busqueda_pres_compl('Control Odontológico (Grupo Niños de 6 a 9 Años)','ctc010a97','fecha_p2','cuie_p2','Control de Salud',$fecha_desde,$fecha_hasta,'ninios_6_anio','hist_ninios_6_anio','fecha_p1');

busqueda_pres_compl('Dosis aplicada de Triple Viral (Actualización Esquema) (Grupo Niños de 6 a 9 Años)','imv001a98','fecha_p3','cuie_p3','Control de Salud',$fecha_desde,$fecha_hasta,'ninios_6_anio','hist_ninios_6_anio','fecha_p1');

busqueda_pres_compl('Dosis aplicada de vacuna triple viral en niños menores de 6 años  (Grupo Niño 0 a 5 años  Cuidado de la Salud)','imv001a98','fecha_p3','cuie_p3','Control de Salud',$fecha_desde,$fecha_hasta,'ninios_6_anio','hist_ninios_6_anio','fecha_p1');

busqueda_pres_compl('Dosis aplicada de Vacuna  doble viral (SR) al ingreso escolar (Grupo Niños de 6 a 9 Años)','imv011a98','fecha_p4','cuie_p4','Control de Salud',$fecha_desde,$fecha_hasta,'ninios_6_anio','hist_ninios_6_anio','fecha_p1');

busqueda_pres_compl('Dosis aplicada de Vacuna  doble viral (SR) al ingreso escolar (Grupo Niño 0 a 5 años  Cuidado de la Salud)','imv011a98','fecha_p4','cuie_p4','Control de Salud',$fecha_desde,$fecha_hasta,'ninios_6_anio','hist_ninios_6_anio','fecha_p1');

busqueda_pres_compl('Dosis aplicada de Sabín en niños de 2, 4, 6 y 18 meses y 6 años o actualización de esquema (Grupo Niño 0 a 5 años  Cuidado de la Salud)','imv002a98','fecha_p5','cuie_p5','Control de Salud',$fecha_desde,$fecha_hasta,'ninios_6_anio','hist_ninios_6_anio','fecha_p1');

busqueda_pres_compl('Dosis aplicada de Sabin Oral (Actualización esquema) (Grupo Niños de 6 a 9 Años)','imv002a98','fecha_p5','cuie_p5','Control de Salud',$fecha_desde,$fecha_hasta,'ninios_6_anio','hist_ninios_6_anio','fecha_p1');

busqueda_pres_compl('Dosis aplicada de dTap Triple Acelular (Actualización esquema en niños mayores 7 años) (Grupo Niños de 6 a 9 Años)','imv008a98','fecha_p6','cuie_p6','Control de Salud',$fecha_desde,$fecha_hasta'ninios_6_anio','hist_ninios_6_anio','fecha_p1');

set_valores('ninios_6_anio','Control de Salud',1);
};
